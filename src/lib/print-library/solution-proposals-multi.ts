...
export function multiPagesFor(content: SolutionProposalContent): MultiProposalPage[] {
  ...
  return [
    ...
    {
      id: "p-locations-americas",
      kind: "locations-region",
      navLabel: "Americas",
      eyebrow: "Regional footprint",
      title: "Americas\nLocations",
      body: "North, Central, and South American delivery centers cover every US time zone, with production hubs in New York, Chicago, and Los Angeles.",
      mapRegion: "AMERICAS",
    },
    {
      id: "p-locations-emea",
      ...
      eyebrow: "Regional footprint",
      title: "EMEA\nLocations",
      body: "Europe, the Middle East, and Africa are served from in-country offices, so regulated market reviews happen in local business hours.",
      mapRegion: "EMEA",
    },
    {
      id: "p-locations-apac",
      ...
      eyebrow: "Regional footprint",
      title: "APAC\nLocations",
      body: "Asia-Pacific production runs from Tokyo, Shanghai, Singapore, and Sydney, closing the follow-the-sun cycle for overnight turnarounds.",
      mapRegion: "APAC",
    },
    {
      id: "p-clients",
