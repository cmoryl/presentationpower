...
export const LEGAL_CASE_STUDIES: LegalCaseStudySeed[] = [
  {
    ...
    teaser:
      "Our client, an Am Law 10 firm, met a 60-day DOJ second request deadline with innovative data analytics and TAR.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal partnered with an Am Law 10 firm to manage a 30+ TB DOJ second request, successfully meeting a 60-day deadline using advanced data analytics and TAR protocols.",
      challenge: {
      ...
      stats: [
        {
          label: "Data volume reduction",
          value: "98",
          unit: "%",
          caption: "from 30+ TB to 410 GB",
        },
        {
          label: "Documents coded using TAR",
          value: "85",
          unit: "%",
  ...
  },
  {
    ...
    teaser:
      "A US financial institution leverages generative AI for rapid, cost-effective document review in complex litigation.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal deployed generative AI to accelerate document review for a US financial institution, addressing an urgent disclosure request with high accuracy and significant cost savings.",
      challenge: {
      ...
      stats: [
        {
          label: "Reduction in review costs",
          value: "66",
          unit: "%",
          caption: "compared to traditional methods",
        },
        {
          label: "Precision rate",
          value: "93.9",
          unit: "%",
          caption: "in GenAI responsiveness coding",
        },
  ...
  },
  {
    ...
    teaser:
      "Our custom AI translation workflow helped two Asia-headquartered companies meet tight DOJ and EC merger control deadlines.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal supported a billion-dollar acquisition, successfully navigating Second Request and Phase 2 investigations by the DOJ and EC with custom AI translation solutions.",
      challenge: {
        heading: "The Challenge",
      ...
      stats: [
        {
          label: "Saved in translation costs",
          value: "$MILLIONS",
          caption: "potential translation costs",
        },
        {
          label: "EC requirements fulfillment",
          value: "TWO-WEEK",
          caption: "EC requirements fulfillment",
        },
        {
          label: "DOJ compliance deadline",
          value: "SATISFACTORY",
          caption: "DOJ compliance deadline completion",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "By leveraging advanced analytics, TransPerfect Legal helped a global manufacturer significantly reduce eDiscovery costs and review time in a product defect class action.",
    tags: ["ediscovery", "analytics", "cost-reduction", "class-action", "product-liability"],
    practice: "Litigation & class actions",
    sourceFile:
      "TPLegal_AdvancedAnalyticsDrivesMassiveEfficiencyinProductDefectClassAction_CaseStudy_US.pdf",
    content: {
      eyebrow: "Case study",
      ...
      summary:
        "TransPerfect Legal partnered with a global manufacturer to streamline eDiscovery in a high-stakes class action, dramatically reducing the document review volume through advanced analytics.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          label: "Saved in review costs",
          value: "$1,165,374",
          caption: "through analytics-driven review optimization",
        },
        {
          label: "Hours eliminated",
          value: "27,747",
          caption: "from review cycle, freeing nearly 140 business days",
        },
        {
          label: "Review volume reduced by",
          value: "96.4",
          unit: "%",
          caption: "while maintaining defensible litigation strategy",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "An SEC investigation required a global financial institution to perform eDiscovery on-site due to strict South Korean data privacy laws.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal provided on-site eDiscovery services in Seoul, South Korea, enabling a global financial institution to comply with local data privacy laws and SEC requirements.",
      challenge: {
        heading: "The challenges",
  ...
  },
  {
    ...
    teaser:
      "A global private equity firm consolidated eDiscovery providers to achieve significant cost savings and streamline complex litigation workflows.",
    tags: ["ediscovery", "private equity", "cost savings", "litigation management"],
    practice: "Litigation & class actions",
    sourceFile:
      "TPLegal_UnlockingScaleCoordinatedeDiscoveryforaGlobalPrivateEquityFirm_CaseStudy_US.pdf",
    content: {
      eyebrow: "Case study",
      ...
      summary:
        "This case study details how a major global private equity firm centralized its eDiscovery operations, moving from a fragmented approach to a single, coordinated solution. The firm achieved substantial cost reductions and operational efficiencies across its fund and numerous portfolio companies.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        ...
        {
          label: "Saved vs. ad-hoc approach",
          value: "MILLIONS",
          caption: "compared to an ad-hoc vendor approach",
        },
        { label: "Workflows", value: "STREAMLINED", caption: "eliminating redundant collections" },
        {
          label: "Visibility & control",
          value: "GREATER",
          caption: "over enterprise-wide litigation spend",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "Navigating simultaneous regulatory reviews for an acquisition across the US and EU requires precise multilingual eDiscovery.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal provided multilingual eDiscovery and managed review for a US company facing dual regulatory reviews from the DOJ and European Commission for a cross-border acquisition.",
      challenge: {
        heading: "The challenge",
      ...
      stats: [
        {
          ...
          value: "20",
          unit: "%",
          caption: "through optimized project execution",
        },
  ...
  },
  {
    ...
    teaser:
      "TransPerfect Legal provided multi-jurisdictional eDiscovery support for a complex automotive class action lawsuit.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal supported a group of Australian car dealerships in a class action against a German automotive manufacturer, navigating complex cross-border data challenges and tight deadlines.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          label: "Saved in technology and hosting fees",
          value: "$50K+",
          caption: "Project cost savings",
        },
  ...
  },
  {
    ...
    teaser:
      "A defense industry manufacturer achieved 99% data reduction in a classified environment to meet a critical production deadline.",
    tags: ["e-discovery", "data reduction", "classified data", "digital reef"],
    practice: "eDiscovery technology",
    sourceFile:
      "TPLegal_DefenseIndustryManufacturerAchieves99%DataReductioninClassifiedEnvironment_CaseStudy_US.pdf",
    content: {
      eyebrow: "Case study",
      ...
      summary:
        "TransPerfect Legal helped a defense industry manufacturer achieve over 99% data reduction for a sensitive dataset in a classified environment, meeting a critical 10-day deadline.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        ...
        {
          label: "Data reduction achieved",
          value: "99",
          unit: "%",
          caption: "Through targeted filtering",
        },
  ...
  },
  {
    ...
    teaser:
      "An Am Law 10 firm leveraged on-premise eDiscovery to protect sensitive client data across multiple, complex custodian locations.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal deployed a bespoke, on-premise eDiscovery solution for an Am Law 10 firm facing shareholder litigation, protecting highly confidential data across multiple custodian locations with strict deadlines.",
      challenge: {
        heading: "The challenge",
      ...
      stats: [
        {
          ...
          value: "On-premise",
          caption: "Complex, high-security solution",
        },
        ...
        { label: "Time to deploy", value: "Short notice", caption: "Meeting aggressive deadlines" },
        {
          ...
          value: "Ensured",
          caption: "Forensically wiped collection media",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "TransPerfect Legal provided end-to-end digital forensics, from investigation to remediation, for a federal trade secret litigation.",
    ...
    content: {
      ...
      summary:
        "Our team supported a federal litigation for an international manufacturer against a former employee accused of sharing trade secrets. We delivered comprehensive forensic services from initial assessment through to data remediation.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          label: "Defensible Preservation",
          value: "ESTABLISHED",
          caption: "Early forensic planning",
        },
  ...
  },
  {
    ...
    teaser:
      "An advanced analytics approach cut review costs and time in a complex bribery investigation for a medical device company.",
    ...
    content: {
      ...
      summary:
        "A global medical device company needed to investigate a bribery allegation in its Ukrainian subsidiary. TransPerfect Legal used advanced analytics and language expertise to conduct a thorough and cost-effective review.",
      challenge: {
        heading: "The challenge",
      ...
      stats: [
        { label: "Review completed in", value: "33 hours", caption: "Time to complete the review" },
        {
          label: "Cost savings",
          value: "50,000 €",
          caption: "Estimated savings due to efficient process",
        },
        {
          label: "Review volume reduced by",
          value: "96",
          unit: "%",
          caption: "Reduction in documents needing review",
        },
        {
          label: "Budget, delivered on time",
          value: "6,000 €",
          caption: "Project budget maintained",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "Reef Review provided a national law firm with a cost-effective and feature-rich eDiscovery platform for matters of all sizes.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal introduced its Reef Review platform to a national law firm, addressing their need for an advanced yet affordable eDiscovery solution. This allowed the firm to efficiently manage diverse cases, from small to complex, without compromising functionality or support.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          ...
          value: "$50,000",
          caption: "achieved with Reef Review",
        },
        {
          label: "Cull rate",
          value: "90",
          unit: "%",
          caption: "achieved through optimized processing",
        },
  ...
  },
  {
    ...
    teaser:
      "A rapid-transit rail system faced a tight deadline to produce documents for land acquisition, requiring efficient data handling.",
      ...
      stats: [
        {
          ...
          value: "1,301 GB",
          caption: "from Microsoft 365, Teams, and OneDrive",
        },
        {
          label: "Cull rate achieved",
          value: "90",
          unit: "%",
          caption: "significantly exceeding industry average",
        },
        {
          label: "Review time eliminated",
          value: "4,900 Hours",
          caption: "due to advanced analytics",
        },
  ...
  },
  {
    ...
    teaser:
      "Seamlessly navigate complex European merger control investigations with expert e-discovery and managed review.",
    ...
    content: {
      ...
      audience: "Legal professionals facing international regulatory scrutiny",
      summary:
        "TransPerfect Legal supported a global medical company acquiring a European-headquartered target through in-depth merger control investigations by the CMA and ACCC, ensuring timely disclosure.",
      challenge: {
        heading: "The Challenge",
      ...
      stats: [
        ...
        {
          label: "Document reduction",
          value: "99",
          unit: "%",
          caption: "Minimizing review burden",
        },
  ...
  },
  {
    ...
    teaser:
      "Seamlessly supporting a boutique law firm through a fast-moving EC dawn raid investigation with end-to-end forensic and review solutions.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal partnered with a boutique law firm to provide urgent support during an unannounced EC dawn raid, ensuring full compliance and facilitating a leniency application.",
      challenge: {
        heading: "The challenge",
      ...
      stats: [
        {
          label: "Turnaround for data processing",
          value: "24 HOUR",
          caption: "for data processing and review",
        },
        {
          label: "Multilingual review completed",
          value: "AI-assisted",
          caption: "with AI-assisted workflows",
        },
  ...
  },
  {
    ...
    teaser:
      "This case study details a pharmaceutical company's journey to organize, remediate, and protect its vast stores of corporate data.",
    tags: [
      "data governance",
      "remediation",
      "risk management",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal helped a major pharmaceutical company implement a comprehensive data remediation program to reduce risk and protect trade secrets. The initiative aimed to organize valuable data while defensibly disposing of redundant or irrelevant content.",
      challenge: {
        heading: "The Challenge",
      ...
      stats: [
        {
          label: "Reduction of total data footprint",
          value: "75",
          unit: "%",
          caption: "Defensible reduction achieved",
        },
        {
          label: "Data identified as duplicates",
          value: "50",
          unit: "%",
          caption: "From primary data repository",
        },
        {
          label: "Data identified as digital debris",
          value: "25",
          unit: "%",
          caption: "No legal, regulatory, or business value",
        },
        {
          label: "Meaningful data retained",
          value: "25",
          unit: "%",
          caption: "Valuable for business or compliance",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "TransPerfect Legal provided on-site forensic data collection and processing for a global corruption investigation, ensuring strict security and compliance.",
    tags: ["forensics", "ediscovery", "data collection", "compliance"],
    practice: "Forensics & investigations",
    sourceFile:
      "TPLegal_GlobalDataCollectionwithOn-SiteProcessingforCorruptionInvestigation_CaseStudy_US.pdf",
    content: {
      eyebrow: "Case study",
      ...
      summary:
        "TransPerfect Legal assisted a Fortune 500 manufacturer facing a global corruption investigation by deploying on-site data collection and processing across multiple international locations. The solution ensured data security and compliance with strict internal protocols.",
      challenge: {
        heading: "The challenge",
      ...
      stats: [
        {
          label: "Attorney review costs saved",
          value: "$500,000",
          caption: "Saved in attorney review costs",
        },
        { label: "Data reduction", value: "98", unit: "%", caption: "Reduction of the dataset" },
        {
          ...
          value: "98",
          unit: "%",
          caption: "Data retention on client premises",
        },
  ...
  },
  {
    ...
    teaser:
      "A multi-billion-dollar healthcare provider saved over $400,000 by centralizing their legal data in a multi-matter repository.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal helped a healthcare client recover and centralize 10 TB of corrupted legal data into a multi-matter repository, enabling significant cost savings and faster insights across numerous legal matters.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          label: "Processing costs saved",
          value: "$410,000",
          caption: "in the first three months",
        },
  ...
  },
  {
    ...
    teaser:
      "An international private equity firm successfully met stringent EC regulatory obligations with expert support and rapid document review.",
  ...
  },
  {
    ...
    teaser:
      "Optimized collection, processing, and AI-enhanced review of multilingual data for parallel litigation in complex construction disputes.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal's Construction Disputes Practice Group (CDPG) handled the complex data challenges of parallel litigation for an international construction conglomerate, optimizing multilingual data collection, processing, and AI-enhanced review.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          label: "Cost savings on review",
          value: "50",
          unit: "%",
          caption: "by avoiding duplicative work",
        },
        {
          label: "Initial data cull rate",
          value: "95",
          unit: "%",
          caption: "achieved through targeted keyword searches",
        },
        {
          label: "Documents reviewed by bilingual staff",
          value: "300,000",
          caption: "by TransPerfect Legal contract reviewers",
        },
        {
          label: "Reduction in second-level review",
          value: "50 %+",
          caption: "via AI-enhanced TAR workflows",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "A Middle Eastern EPC and FM contractor faced tight deadlines for a substantial claim in an international airport construction project.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal enabled a contractor to manage a complex international infrastructure dispute, despite 15 million records, multi-global teams, and tight deadlines. Our forensic and analytical approach significantly reduced data volume and expedited review.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          label: "Initial records collected",
          value: "15 million",
          caption: "from disparate sources",
        },
        {
          label: "Project completion",
          value: "600 hours",
          caption: "vs. 35,000 traditional hours",
        },
        {
          label: "Reduction in review costs",
          value: "98",
          unit: "%",
          caption: "achieved through integrated workflow",
        },
        {
          label: "Reduction in review population",
          value: "30",
          unit: "%",
          caption: "due to email threading alone",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "A major law firm leveraged custom fact-finding workflows to navigate a complex SEC investigation with a tight deadline.",
    tags: [
      "e-discovery",
      "managed review",
      "sec investigation",
    ...
    practice: "Investigations & compliance",
    sourceFile:
      "TPLegal_NavigatingSECInvestigationswithCustomFact-FindingWorkflows_CaseStudy_US.pdf",
    content: {
      eyebrow: "Case study",
      ...
      summary:
        "TransPerfect Legal partnered with a major law firm to conduct a rapid, multi-language review for a critical SEC investigation, delivering results under significant time pressure.",
      challenge: {
        heading: "The challenges",
  ...
  },
  {
    ...
    teaser:
      "A global law firm faced challenges reviewing plaintiff fact sheets in a multi-district litigation, requiring adaptable solutions.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal partnered with a global law firm to optimize plaintiff fact sheet review in a multi-district litigation, ensuring compliance and achieving significant cost savings.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          ...
          value: "45",
          unit: "%",
          caption: "achieved through offshore review",
        },
        {
          label: "Plaintiff fact sheets",
          value: "726",
          caption: "reviewed for accuracy and compliance",
        },
  ...
  },
  {
    ...
    teaser:
      "TransPerfect Legal helped an Am Law 25 firm meet a tight DOJ production deadline for a second request, despite last-minute scope changes.",
    ...
    content: {
      ...
      summary:
        "An Am Law 25 law firm representing a global media company faced a challenging second request from the DOJ with multiple data sources and tight deadlines. TransPerfect Legal provided rapid forensic data collection, processing, and managed review solutions to ensure timely production.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          label: "Days to complete initial production",
          value: "60 days",
          caption: "Initial deadline for collection, processing, review, and production",
        },
        {
          label: "Additional custodians for text messages",
          value: "18",
          caption: "Last-minute DOJ request for mobile data",
        },
        {
          label: "Custodians for initial data collection",
          value: "32",
          caption: "Number of custodians for diverse data sources",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "Faced with parallel SEC and DOJ investigations, an investment company required an on-premise, air-gapped eDiscovery solution.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal provided an on-premise, air-gapped eDiscovery and review solution for a US investment company facing parallel SEC and DOJ investigations.",
      challenge: {
        heading: "The challenge",
  ...
  },
  {
    ...
    teaser:
      "A global medical device manufacturer implemented a proactive digital forensics program to prevent intellectual property theft during employee departures.",
    tags: ["digital forensics", "intellectual property", "data security", "employee departure"],
    practice: "Forensics & investigations",
    sourceFile:
      "TPLegal_ProactiveDigitalForensicsProgramPreventsIntellectualPropertyTheft_CaseStudy_US.pdf",
    content: {
      eyebrow: "Case study",
      ...
      summary:
        "TransPerfect Legal developed and implemented a custom Employee Departure Program (EDP) for a medical device manufacturer, leveraging forensic technology to prevent intellectual property theft. This program provides proactive protection against data loss during employee transitions.",
      challenge: {
        heading: "The challenge",
      ...
      stats: [
        {
          label: "Investigations confirmed",
          value: "MULTIPLE",
          caption: "misappropriation of confidential info",
        },
        {
          label: "Data recovery/neutralization",
          value: "WITHOUT",
          caption: "triggering costly litigation",
        },
        {
          label: "Risk-based triggers enabled",
          value: "DEFENSIBLE",
          caption: "consistent oversight of departures",
        },
        {
          label: "Client gained peace of mind",
          value: "PROACTIVE",
          caption: "IP protection at scale",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "A boutique law firm found an affordable, full-featured eDiscovery solution for small datasets and budget-sensitive clients.",
    ...
    content: {
      ...
      summary:
        "This boutique law firm needed an eDiscovery solution that could handle small, budget-sensitive cases without sacrificing advanced features. They adopted Reef Express to gain access to powerful tools like Digital Reef and Relativity affordably.",
      challenge: {
        heading: "The challenges",
  ...
  },
  {
    ...
    teaser:
      "TransPerfect Legal enabled a US investment advisor to quickly collect and review mobile device data for an SEC investigation.",
    ...
    content: {
      ...
      audience: "Legal professionals, Compliance officers, eDiscovery managers",
      summary:
        "Our team provided rapid, secure mobile device collection and review services for an investment advisor under SEC investigation, ensuring compliance and data privacy.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        ...
        { label: "Review hours saved", value: "Hundreds", caption: "through automated redaction" },
        {
          ...
          value: "Protected",
          caption: "through secure, on-site filtering",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
  ...
  },
  {
    ...
    teaser:
      "We provided secure, high-quality translations for a global pharmaceutical company navigating multiple concurrent anti-corruption investigations.",
    ...
    content: {
      ...
      audience: "Legal professionals, corporate legal departments",
      summary:
        "TransPerfect Legal partnered with a Fortune 500 pharmaceutical company to provide secure, high-quality translations for multiple anti-corruption investigations. Our centralized workflow ensured consistent quality and faster review cycles across 10 languages.",
      challenge: {
        heading: "The challenges",
      ...
      stats: [
        {
          label: "Average SLA overperformance",
          value: "130",
          unit: "%",
          caption: "Delivering faster turnaround times",
        },
        {
          label: "Languages translated",
          value: "10",
          caption: "Across EU, APAC, and South America",
        },
  ...
  },
  {
    ...
    teaser:
      "A global law firm leveraged TransPerfect Legal to manage a high-volume, multi-district litigation review, achieving significant cost savings.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal supported a global law firm with a large-scale, multi-district litigation review involving over 1.7 million documents. Our managed review services ensured accurate categorization, privilege redactions, and timely production.",
      challenge: {
        heading: "The challenge",
      ...
      stats: [
        {
          ...
          value: "45",
          unit: "%",
          caption: "achieved through offshore managed review",
        },
        {
          label: "Documents processed and reviewed",
          value: "1.7 MILLION",
          caption: "total documents handled in the litigation",
        },
  ...
  },
  {
    ...
    teaser:
      "A Fortune 50 healthcare company optimized eDiscovery workflows for labor and employment matters with a unified platform.",
    ...
    content: {
      ...
      summary:
        "TransPerfect Legal helped a global healthcare provider streamline eDiscovery for labor and employment matters by implementing Digital Reef as its primary technology solution. This enabled efficient processing, analysis, and review of data within a single platform.",
      challenge: {
        heading: "The Challenge",
      ...
      stats: [
        ...
        {
          label: "Data retained in-platform",
          value: "97",
          unit: "%",
          caption: "Data not requiring export to secondary platform",
        },
        {
          label: "Matters handled",
          value: "Several dozen",
          caption: "Projects run through Digital Reef",
        },
      ],
      engagement: {
        title: "Engagement snapshot",
