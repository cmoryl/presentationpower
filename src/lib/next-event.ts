 ...
 */
export const NEXT_LONDON_AGENDA_URL = `${NEXT_APP_ORIGIN}/events/next/agendas`;
...
export const NEXT_CITY_SERIES: {
  ...
  stops: [
    ...
    },
    {
      ...
      status: "confirmed",
      note: "Second confirmed edition — partner stands run on TV kiosks instead of trade-booth walls.",
    },
