...
> = {
  ...
  "vt-pillar-wrap": { area: "Foyer columns", qty: (b) => Math.max(2, b.floors) },
  "vt-cover-wall": { area: "Press and photo wall", qty: () => 1 },
  "vt-fascia": { area: "Desk and stand headers", qty: (b) => b.desks + b.partnerStands },
};
