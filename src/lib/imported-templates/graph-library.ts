  ...
  slides: [
    ...
    },
    {
      ...
      content: {
        ...
        highlight: "Sep",
        bars: [
          { label: "Jan", value: 42 }, { label: "Feb", value: 48 },
          { label: "Mar", value: 55 }, { label: "Apr", value: 61 },
          { label: "May", value: 58 }, { label: "Jun", value: 66 },
          { label: "Jul", value: 72 }, { label: "Aug", value: 78 },
          { label: "Sep", value: 94 }, { label: "Oct", value: 83 },
          { label: "Nov", value: 88 }, { label: "Dec", value: 91 },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        ...
        items: [
          { value: 92, label: "Enterprise", body: "Net revenue retention across 120 accounts.", meta: "2024" },
          { value: 87, label: "Mid-market", body: "Retention lift after onboarding redesign.", meta: "2025" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        ...
        items: [
          { label: "Discovery", done: 12, total: 12, body: "All interviews complete; synthesis in review." },
          { label: "Build", done: 18, total: 24, body: "Six modules remaining in the sprint plan." },
    ...
    },
    {
      ...
      content: {
        ...
        series: [
          { label: "2016", value: 120 }, { label: "2017", value: 140 },
          { label: "2018", value: 168 }, { label: "2019", value: 195 },
          { label: "2020", value: 210 }, { label: "2021", value: 258 },
          { label: "2022", value: 302 }, { label: "2023", value: 355 },
          { label: "2024", value: 410 }, { label: "2025", value: 478 },
        ],
    ...
    },
    {
      ...
      content: {
        ...
        unit: "M",
        segments: [
          { label: "New logo" }, { label: "Expansion" }, { label: "Renewal" },
        ],
        columns: [
