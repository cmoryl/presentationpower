...
export type ModuleVariant = {
  ...
  /**
   * Budgets keyed BY FIELD NAME, so a caller can tell what to send and how long
   * it may be. Keys in `fields` are exactly the paths listed in
   * `editableFields`; keys in `items.fields` are those paths with the
   * `items[].` prefix removed. `assertCapacityIntegrity` (taxonomy-capacity.ts)
   * proves both directions: no editable text field without a budget, no budget
   * without a field.
   */
  capacity: {
    fields: Record<string, import("./taxonomy-field-kinds").FieldSpec>;
    items?: {
      /**
       * Collection the count governs. Defaults to `items`; a few variants count
       * a differently-named array (`series`, `stages`, `bars`…), and the count
       * has to name it or it looks like an orphan budget.
       */
      path?: string;
      min: number;
      max: number;
    ...
    /** @deprecated Generic alias kept for the library UI and export verifier. */
    titleChars?: number;
    /** @deprecated Generic alias kept for the library UI and export verifier. */
    bodyChars?: number;
  };
...
export const MODULE_VARIANTS: ModuleVariant[] = [
  ...
  {
    id: "MV-PROOF-GROWTH-ORBITS",
    familyId: "MF-05",
    name: "Growth proof split (logos + orbit stats)",
    description:
      "Acquisition logo wall and numbered growth stats on the left, up to three orbit percentage figures on the right",
    permittedLayoutIds: ["LF-19"],
    capacity: {
      fields: {
        title: { kind: "text", chars: 40 },
        subtitle: { kind: "text", chars: 90 },
        logosLabel: { kind: "text", chars: 30 },
        growthLabel: { kind: "text", chars: 30 },
        statsTitle: { kind: "text", chars: 44 },
        statsEmphasis: { kind: "text", chars: 20 },
        "growth[].value": { kind: "text", chars: 6 },
        "growth[].label": { kind: "text", chars: 40 },
        "growth[].body": { kind: "text", chars: 80 },
        "orbits[].label": { kind: "text", chars: 24 },
        "orbits[].value": { kind: "text", chars: 6 },
        "orbits[].body": { kind: "text", chars: 110 },
      },
      items: {
        min: 4,
        max: 12,
  ...
  },
  {
    id: "MV-SOL-CAP-CARDS",
    familyId: "MF-04",
    name: "Capability cards (photo · label band · bullets)",
    description:
      "Two to four cards, each with its own photograph, a filled label band and a lead claim over ruled bullet points",
    permittedLayoutIds: ["LF-08"],
    capacity: {
      fields: {
        title: { kind: "text", chars: 56 },
        "cards[].label": { kind: "text", chars: 18 },
        "cards[].lead": { kind: "text", chars: 40 },
        "cards[].leadNote": { kind: "text", chars: 60 },
        "cards[].bullets[]": { kind: "text", chars: 46 },
        "cards[].mediaSeed": { kind: "image" },
        "cards[].mediaUrl": { kind: "image" },
        "cards[].mediaPath": { kind: "image" },
      },
      titleChars: 56,
      bodyChars: 46,
    },
  ...
  },
  {
    ...
    capacity: {
      fields: {
        title: { kind: "text", chars: 48 },
        body: { kind: "text", chars: 180 },
        mediaSeed: { kind: "image" },
        "benefits[].label": { kind: "text", chars: 44 },
        "benefits[].icon": { kind: "text", chars: 24 },
      },
      titleChars: 48,
      bodyChars: 180,
    },
    editableFields: ["title", "body", "mediaSeed", "benefits[].label", "benefits[].icon"],
    lockedFields: ["footer", "logo"],
  },
  {
    id: "MV-PROOF-CERT-ORBITS",
    familyId: "MF-05",
    name: "Credential proof split (card + certification orbits)",
    description:
      "Programme card with headline pass rates and bullets on the left, up to three certifications in hairline orbit rings on the right",
    permittedLayoutIds: ["LF-19"],
    capacity: {
      fields: {
        title: { kind: "text", chars: 44 },
        cardTitle: { kind: "text", chars: 56 },
        "cardHighlights[]": { kind: "text", chars: 44 },
        "cardPoints[]": { kind: "text", chars: 44 },
  ...
  {
    id: "MV-VIZ-STACKED-AREA",
    familyId: "MF-05",
    name: "Stacked area — composition over time",
    description:
  ...
  {
    id: "MV-VIZ-RADIAL-BAR",
    familyId: "MF-05",
    name: "Radial bars — progress rings",
    description:
  ...
  {
    id: "MV-VIZ-GAUGE-GRID",
    familyId: "MF-05",
    name: "Gauge grid — scorecard dials",
    description:
  ...
  },
  {
    id: "MV-VIZ-BOXPLOT",
    familyId: "MF-05",
    name: "Box plot — spread and outliers",
    description:
