...
export const MODULE_VARIANTS: ModuleVariant[] = [
  ...
  {
    id: "MV-PROC-TIMELINE-RAIL",
    familyId: "MF-04",
    name: "Timeline rail (3-7 stops)",
    description:
      "Horizontal axis with icon nodes and alternating above/below cards, each with a date or duration marker",
    permittedLayoutIds: ["LF-14"],
    capacity: { items: { min: 3, max: 7 }, titleChars: 60, bodyChars: 120 },
    editableFields: [
      "title",
      "subtitle",
      "items[].meta",
  ...
  {
    id: "MV-PROC-JOURNEY-VERTICAL",
    familyId: "MF-04",
    name: "Journey timeline (vertical, 3-6)",
    description:
      "Vertical rail with icon nodes, phase chips and a full paragraph per stage — for journeys that need explaining",
    permittedLayoutIds: ["LF-13"],
    capacity: { items: { min: 3, max: 6 }, titleChars: 60, bodyChars: 220 },
    editableFields: [
      "title",
      "subtitle",
      "items[].meta",
  ...
  {
    id: "MV-PROC-SWIMLANE-FLOW",
    familyId: "MF-04",
    name: "Swimlane flow (lanes x phases)",
    description:
      "Phases across the top, workstream lanes down the side, icon chips per cell — who does what, when",
    permittedLayoutIds: ["LF-14"],
    capacity: { items: { min: 2, max: 4 }, titleChars: 60, bodyChars: 90 },
    editableFields: [
      "title",
      "subtitle",
      "phases[].label",
