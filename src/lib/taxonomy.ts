...
export const BRAND_MODES: BrandMode[] = [
  ...
  },
  {
    ...
    // Deep navy field + emerald aurora (aqua sibling generated by shiftHue).
    // Matches the tp-games-dark backdrop set (navy + emerald/aqua glows) and
    // the pale-green light backdrops.
