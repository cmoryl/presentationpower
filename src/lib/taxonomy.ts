...
export const BRAND_MODES: BrandMode[] = [
  ...
  },
  {
    ...
    // NEXT Games green #A6FA87 (master palette, Pantone 7487 C) on a deep navy
    // field. Aqua sibling is generated by shiftHue in flagship.tsx.
    tokens: { primary: "#0A1230", accent: "#A6FA87", surface: "#EDFBE5", ink: "#03002C" },
  },
  {
    id: "bm-tp-digital",
  ...
  {
    id: "bm-tp-finance",
    name: "TransPerfect Finance",
    description: "Financial services: banking, asset management, regulatory & investor content",
    // NEXT Finance peach #FF9B70 (Pantone 1635 C) — ink field like Media, pale
    // peach light surface derived from the accent.
    tokens: { primary: "#03002C", accent: "#FF9B70", surface: "#FCEBE2", ink: "#03002C" },
  },
  {
    id: "bm-tp-experience",
    name: "TransPerfect Experience",
    description: "Customer experience: contact centre, CX content, support & community",
    // NEXT Experience red #FF5757 (Pantone 1785 C) — ink field keeps the warm
    // accent from vibrating; pale coral light surface.
    tokens: { primary: "#03002C", accent: "#FF5757", surface: "#FDE8E8", ink: "#03002C" },
  },
  {
    id: "bm-tp-learn",
    name: "TransPerfect Learn",
    description: "Learning & development: eLearning localization, training and enablement",
    // NEXT Learn yellow #FFEB66 (Pantone 100 C) — Blue 500 ink, matching how
    // Digital / Life Sci anchor their high-key accents; pale butter surface.
    tokens: { primary: "#003FC7", accent: "#FFEB66", surface: "#FEF9DC", ink: "#03002C" },
  },
  {
  ...
  },
  {
    ...
    // Warm gold #E0A82E — deliberately outside the NEXT division ramp so a
    // co-branded deck never reads as a division. Finance owns #FF9B70.
    tokens: { primary: "#03002C", accent: "#E0A82E", surface: "#FBF1DC", ink: "#03002C" },
  },
];
