...
export const NEXT_VENUE_TEMPLATES: VenueTemplateFamily[] = [
  ...
  {
    id: "vt-desk-front",
    name: "Help desk front",
    substrate: "Desk fascia vinyl",
    slots: ["utility", "lockup"],
    ground: "house-gradient",
    orientation: "landscape",
    londonPanels: ["ldn-s05", "ldn-22", "ldn-49", "ldn-v75"],
  ...
  },
  {
    ...
    ground: "house-gradient",
    orientation: "portrait",
    londonPanels: ["ldn-s07"],
    printNote: "Lockup only — no copy on a return this narrow.",
  },
  {
    id: "vt-registration-desk",
    name: "Registration desk suite",
    substrate: "Registration desk run: front fascia, side cheeks and end returns",
    slots: ["utility", "lockup", "headline"],
    ground: "desk-gradient",
    orientation: "landscape",
    londonPanels: [
      "ldn-v62",
      "ldn-v63",
    ...
    printNote:
      "One run per bank of desks: long fronts panelised to the vendor's widths, plus a left and right side cheek and a narrow end return. The ground runs continuously across the whole bank — output the fronts from one artboard and cut, so the ramp does not restart at each join. Lockup on the front only; sides and returns carry ground alone.",
  },
  {
    id: "vt-cloakroom",
    name: "Cloakroom counter",
    substrate: "Cloakroom counter fascia and side vinyl",
    slots: ["utility", "lockup"],
    ground: "house-gradient",
    orientation: "landscape",
    londonPanels: ["ldn-v68", "ldn-v69"],
    printNote:
      "Counter front carries the utility word (CLOAKROOM) and the white lockup; the side vinyl is a small ground-only patch. Allow for the counter lip — keep copy 120 mm clear of the top edge where coats are handed over.",
  },
  {
    id: "vt-merch-mart",
    name: "Merch mart run",
    substrate: "Retail back wall and counter run",
    slots: ["lockup", "headline", "subhead", "qr"],
    ground: "house-gradient",
    orientation: "landscape",
    londonPanels: ["ldn-15", "ldn-16"],
    printNote:
      "Long, shallow retail run behind shelving: keep the lockup and any code out of the shelf bands, and panelise to the build widths. Product sits in front of the panel, so the copy band belongs in the top third.",
  },
  {
    id: "vt-brew-bar",
    name: "NEXTbrew bar",
    substrate: "Coffee bar fascia, back wall and menu plate",
    slots: ["lockup", "headline", "subhead", "qr"],
    ground: "brew-gradient",
    orientation: "landscape",
    londonPanels: [
      "ldn-24",
      "ldn-25",
    ...
    printNote:
      "NEXTbrew set: two tall bar-end panels either side of a wide centre fascia, back-wall panels behind the machines, and a small menu plate. Café motif marks stay live vector. The darker head end holds the white lockup under warm café lighting — never flip the ramp.",
  },
  {
    id: "vt-glass-vinyl",
    name: "Glass vinyl",
