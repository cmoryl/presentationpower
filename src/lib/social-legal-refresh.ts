...
export const LEGAL_REFRESH_DIRECTIONS: LegalRefreshDirection[] = [
  {
    ...
    photo: {
      note: "Golden hour: counsel in charcoal tailoring inside a towering bramble wall, holding one thorn branch aside like a door while light pours through the gap. Left third is empty warm haze for copy.",
      focus: "62% 50%",
      scrim: 0.5,
      ink: "#FFFFFF",
    },
  },
  {
    ...
    headlineCase: "caps",
    photo: {
      note: "Low-key chiaroscuro: a reviewer in a corridor of colossal paper stacks, one file pulled out to make a bright slot he looks straight through. Left half falls to near black for copy.",
      focus: "66% 50%",
      scrim: 0.34,
      ink: "#FFFFFF",
    },
  },
  {
    ...
    headlineCase: "sentence",
    photo: {
      note: "Concrete hall: a car-sized knot of ship's rope on the right, one colleague working it loose, the freed line running dead straight to a woman walking it away. Vast pale wall above as copy space.",
      focus: "56% 62%",
      scrim: 0.42,
      ink: "#03002C",
    },
  },
  {
    ...
    headlineCase: "sentence",
    photo: {
      note: "Silver fog: out of a dark briar thicket in a spotless trench coat with an absurdly squared stack of binders, the chaos left behind on the right. Left half is luminous empty fog for copy.",
      focus: "58% 45%",
      scrim: 0.3,
      ink: "#03002C",
    },
