...
export const LEGAL_REFRESH_DIRECTIONS: LegalRefreshDirection[] = [
  {
    ...
    photo: {
      note: "A counsel in a sharp suit standing waist-deep in a bramble hedge, holding one thorny branch aside like she is holding a door open.",
      focus: "62% 50%",
      scrim: 0.58,
      ink: "#03002C",
    },
  },
  {
    ...
    headlineCase: "caps",
    photo: {
      note: "A reviewer walled in by towers of paper, peering out through the one gap he has made. Single raking light, everything else in shadow.",
      focus: "64% 50%",
      scrim: 0.5,
      ink: "#FFFFFF",
    },
  },
  {
    ...
    headlineCase: "sentence",
    photo: {
      note: "Two colleagues either end of one enormous rope: one works the knot loose, the other walks the freed line dead straight out of frame.",
      focus: "58% 62%",
      scrim: 0.5,
      ink: "#03002C",
    },
  },
  {
    ...
    headlineCase: "sentence",
    photo: {
      note: "Out of the briars and into clear fog, carrying an absurdly tidy stack of binders. The mess is behind her, not on her.",
      focus: "64% 50%",
      scrim: 0.5,
      ink: "#03002C",
    },
