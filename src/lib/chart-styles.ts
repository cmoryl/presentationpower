...
export const SKIN_CHART_STYLES: Record<string, ChartStyle> = {
  ...
  S29: def({ bar: "block", grid: "ticks", axis: "baseline", line: "step", area: "gradient", marker: "square", ringThickness: 0.32, gaugeSweep: 220, barRatio: 0.55, labelTrack: 0.14, valueLabel: "end" }),
  S30: def({ bar: "block", grid: "ticks", axis: "baseline", line: "step", area: "gradient", marker: "square", ringThickness: 0.32, gaugeSweep: 220, barRatio: 0.55, labelTrack: 0.14, valueLabel: "end" }),
};
