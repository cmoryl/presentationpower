...
export const SKIN_GEOMETRY: Record<string, PackGeometry> = {
  ...
  S29: { shape: "brick", scaffold: "shelf", device: "notches", fill: 0.62, layout: { cover: "split", stats: "cards4", grid: "bento", rule: "bar" } },
  S30: { shape: "keystone", scaffold: "canyon", device: "seal", fill: 0.6, layout: { cover: "split", stats: "cards4", grid: "bento", rule: "bar" } },
};
