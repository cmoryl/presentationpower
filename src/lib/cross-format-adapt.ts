...
export const ADAPT_TARGETS: AdaptTarget[] = [
  {
    ...
    caps: { headline: 90, body: 180, points: 3, pointChars: 44 },
    type: {
      eyebrowPx: 26,
      headlinePx: 86,
      bodyPx: 34,
...
function EXTRA_PRINT_TARGETS(): AdaptTarget[] {
  ...
  return [
    ...
    make("flyer-a5", "Flyer · A5", mm(148, 210), "sheet",
      { headline: 90, body: 420, points: 5, pointChars: 90 }, full),
    make("rack-card-dl", "Rack card · DL", mm(99, 210), "sheet",
      { headline: 70, body: 240, points: 4, pointChars: 70 }, ["eyebrow", "headline", "body", "points", "stat"]),
    make("postcard-a6", "Postcard · A6 landscape", mm(148, 105), "landscape",
      { headline: 70, body: 180, points: 4, pointChars: 60 }, ["eyebrow", "headline", "body", "points", "stat"]),
    ...
    make("poster-a3", "Poster · A3", mm(297, 420), "poster",
      { headline: 80, body: 260, points: 4, pointChars: 80 }, ["eyebrow", "headline", "body", "points", "stat"], 1.5),
    // Twice the A3's area: holds more than the A3, never less.
    make("poster-a2", "Poster · A2", mm(420, 594), "poster",
      { headline: 100, body: 360, points: 5, pointChars: 90 }, ["eyebrow", "headline", "body", "points", "stat", "footnote"], 1.6),
    make("tent-card", "Table tent · A6 portrait", mm(105, 148), "poster",
      { headline: 60, body: 120, points: 3, pointChars: 56 }, ["eyebrow", "headline", "body", "points", "stat"], 1.2),
