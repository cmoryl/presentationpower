...
export const ENTERPRISE_GROUNDS: Record<EnterpriseGroundId, EnterpriseGround> = {
  ...
  "column-rail": {
    ...
    build: (a) => [
      ...
      rules(INK, 0.05, 116, 90),
      hatch(90, INK, 0.035, 14),
  ...
  "media-halo-left": {
    ...
    build: (a) => [
      ...
      `radial-gradient(30% 12% at 33% 88%, ${rgba(INK, 0.18)} 0%, ${rgba(INK, 0)} 78%)`,
      hatch(58, INK, 0.04, 10),
  ...
  "media-halo-right": {
    ...
    build: (a) => [
      ...
      `radial-gradient(30% 12% at 67% 88%, ${rgba(INK, 0.18)} 0%, ${rgba(INK, 0)} 78%)`,
      hatch(-58, INK, 0.04, 10),
  ...
  "media-shelf": {
    ...
    build: (a) => [
      ...
      `radial-gradient(60% 10% at 50% 64%, ${rgba(INK, 0.16)} 0%, ${rgba(INK, 0)} 80%)`,
  ...
  "media-frame": {
    ...
    build: (a) => [
      ...
      hatch(112, INK, 0.035, 12),
      `radial-gradient(46% 12% at 50% 92%, ${rgba(INK, 0.16)} 0%, ${rgba(INK, 0)} 80%)`,
      FIELD,
    ],
  },
};
