...
export const ENTERPRISE_GROUNDS: Record<EnterpriseGroundId, EnterpriseGround> = {
  ...
  "diagonal-sweep": {
    ...
    description: "A soft raking wash from one corner — no seam, no hatch.",
    contentZone: "full",
    build: (a) => [
      ...cropMarks(INK, 0.12),
      veil("50% 50%", 70, 64, 0.95),
      bloom("6% 4%", 62, 54, LAV, 0.2),
      bloom("96% 96%", 58, 50, P, 0.14),
      `linear-gradient(112deg, ${rgba(a, 0.1)} 0%, rgba(255,255,255,0) 56%)`,
      FIELD,
    ],
  },
...
export const GROUND_BY_LAYOUT: Partial<Record<string, EnterpriseGroundId>> = {
  ...
  "MV-STAT-TICKER-STRIP": "column-rail",
  "MV-STAT-SPARK-HERO": "thirds-right",
  "MV-STAT-GAUGE-STACK": "center-stage",
  ...
  "MV-PROC-STEP-SPOTLIGHT": "thirds-right",
  "MV-PROC-STAGE-ORBITS": "horizon",
  "MV-PROC-BEFORE-AFTER": "thirds-right",
  "MV-PROC-BEFORE-AFTER-SPLIT": "center-stage",
  "MV-INFO-HUB-SATELLITES": "center-stage",
  "MV-INFO-HUB-PILL-ORBIT": "center-stage",
  "MV-COMPARE-VS-LISTS": "center-stage",
  "MV-PROC-ARC-FLOW": "horizon",
