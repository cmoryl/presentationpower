...
export const DESIGN_SKINS: DesignSkin[] = [
  {
    ...
    description:
      "Product and message take precedence through exact spacing, quiet depth and one commanding focal image.",
  ...
  },
  {
    ...
    description:
      "Translucent material creates hierarchy above content, with refraction, edge light and a solid accessibility fallback.",
  ...
  },
  {
    ...
    reference: "STRIPE",
    description:
      "Technical storytelling gains energy from controlled mesh gradients, precise grids and product-system visualization.",
  ...
  },
  {
    ...
    reference: "LINEAR",
    description:
      "Near-black surfaces, micro-separators and controlled light restore focus for complex product and technical stories.",
  ...
  },
  {
    ...
    reference: "VERCEL",
    description:
      "A black-and-white system uses hard geometry, code-like rhythm and sharp scale changes to communicate technical confidence.",
  ...
  },
  {
    ...
    description:
      "A disciplined grid, semantic color and reliable data patterns make dense enterprise content feel deliberate and scalable.",
  ...
  },
  {
    ...
    description:
      "Soft depth, rounded productivity surfaces and mode-aware material create a calm, familiar enterprise experience.",
  ...
  },
  {
    ...
    description:
      "Color, shape, size and movement guide attention while keeping modular content friendly, adaptive and energetic.",
  ...
  },
  {
    ...
    description:
      "Status, code, versioning and system relationships become the visual language for engineering-first audiences.",
  ...
  },
  {
    ...
    reference: "ATLASSIAN",
    description:
      "Connected workflows, approachable modularity and friendly color make process-heavy stories easier to navigate.",
  ...
  },
  {
    ...
    description:
      "Product, inventory and conversion content is organized around useful merchant decisions rather than decorative retail tropes.",
  ...
  },
  {
    ...
    description:
      "Role-based workflows, tables and operational signals are organized for complex enterprise decision making.",
  ...
  },
  {
    ...
    description:
      "Asymmetric modules combine imagery, statistics and narrative fragments without losing hierarchy or pacing.",
  ...
  },
  {
    ...
    description:
      "Grid, spacing and typography do the work, supported by one decisive accent and almost no decorative noise.",
  ...
  },
  {
    ...
    description:
      "Publication rhythm, captions and evidence-led sequencing turn reports into persuasive, readable narratives.",
  ...
  },
  {
    ...
    description:
      "Low information density, monumental imagery and exact spacing create value through restraint rather than ornament.",
  ...
  },
  {
    ...
    description:
      "Candid people, tactile environments and warm neutrals make complex organizations feel credible, useful and human.",
  ...
  },
  {
    ...
    description:
      "Full-bleed motion, dramatic lighting and oversized type create emotional stakes for launches, stories and live moments.",
  ...
  },
  {
    ...
    description:
      "Line work, coordinates and precision annotations reveal how complex physical systems are assembled and connected.",
  ...
  },
  {
    ...
    description:
      "Charts become the primary narrative surface through small multiples, comparison logic and tightly controlled color.",
  ...
  },
  {
    ...
    description:
      "Biomorphic forms and natural color progressions connect living systems, sustainability and scientific innovation.",
  ...
  },
  {
    ...
    description:
      "Texture, evidence and marginal detail give impact, policy and research stories a trustworthy documentary voice.",
  ...
  },
  {
    ...
    description:
      "Bold blocks, hard rules and exaggerated hierarchy create deliberate tension for expressive, culture-facing work.",
  ...
  },
  {
    ...
    description:
      "Realistic depth, floating objects and orbital composition position products and systems in an immersive spatial canvas.",
  ...
  },
  {
    ...
    description:
      "Typography behaves like image and motion, using crops, scale and rhythm to carry energy across an entire narrative.",
  ...
  },
  {
    ...
    description:
      "Restrained illumination distinguishes AI-generated or recommended content while preserving transparency and trust.",
  ...
  },
  {
    ...
    description:
      "Soft-focus cobalt, aqua and lavender fields support modern luxury without competing with content or photography.",
  ...
  },
  {
    ...
    description:
      "Overlapping imagery, statistics, charts and glass create a sophisticated executive canvas with controlled visual density.",
  ...
  },
  {
    ...
    description:
      "Element's own product language, light: a soft-focus paper field where the five brick colours drift as diffused atmospheric volumes \u2014 air, water and mineral \u2014 under crisp modular type and lifted glass cards.",
    bestFit:
      "Element product marketing \u00b7 platform launches \u00b7 enablement \u00b7 internal rollout",
    mode: "light",
  ...
  },
  {
    ...
    reference: "TRANSPERFECT ELEMENT \u00b7 FIVE-BRICK SYSTEM",
    description:
      "Element's own product language, dark: deep mineral ink with the five brick colours glowing as soft-focus aurora volumes \u2014 luminous, calm and unmistakably the system's own.",
    bestFit:
      "Element launch keynotes \u00b7 product films \u00b7 exec previews \u00b7 event screens",
    mode: "dark",
    palette: ["#080C16", "#F2F6FF", "#3D7CFF", "#08BFC1", "#7C4EF4"],
    typography: "Modular display \u00b7 luminous systematic labels",
    surfaceNote:
      "Deep mineral field \u00b7 glowing diffused volumes \u00b7 translucent brick cards",
...
export const INDUSTRY_RECIPES: IndustryRecipe[] = [
  {
    ...
    presets: [
      { name: "Boardroom Modern", note: "Low-density executive storytelling" },
      { name: "Enterprise Intelligence", note: "Decision-ready data and proof" },
      { name: "Transformation Narrative", note: "Change, capability and roadmap" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Product Precision", note: "UI and value proposition in focus" },
      { name: "Cloud Infrastructure", note: "Technical scale and reliability" },
      { name: "Product-Led Growth", note: "Adoption, workflow and outcomes" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "AI Luminous", note: "Distinctive, explainable AI moments" },
      { name: "Responsible Intelligence", note: "Trust, provenance and controls" },
      { name: "Data Observatory", note: "Analytics and model performance" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Fintech Momentum", note: "Fast, modern financial narrative" },
      { name: "Embedded Finance", note: "Platform and ecosystem storytelling" },
      { name: "Global Commerce", note: "Scale, reach and transaction flow" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Institutional Trust", note: "Governance and long-term credibility" },
      { name: "Markets Terminal", note: "Dense, live financial intelligence" },
      { name: "Wealth Editorial", note: "Premium advisory storytelling" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Risk Intelligence", note: "Exposure, scenarios and protection" },
      { name: "Claims Clarity", note: "Journey and service resolution" },
      { name: "Insurtech Modern", note: "Digital product and automation" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Security Command", note: "Threat visibility and response" },
      { name: "Zero Trust", note: "Identity, access and architecture" },
      { name: "Compliance Evidence", note: "Controls, audit and assurance" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Clinical Clarity", note: "Evidence, outcomes and pathways" },
      { name: "Human Care", note: "Patient and clinician experience" },
      { name: "Digital Health", note: "Connected services and product" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Scientific Evidence", note: "Research and clinical proof" },
      { name: "Molecular Discovery", note: "Innovation and mechanisms" },
      { name: "Patient Journey", note: "Human impact across the pathway" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Legal Authority", note: "Executive legal briefing" },
      { name: "Case Architecture", note: "Facts, chronology and evidence" },
      { name: "Regulatory Brief", note: "Requirements, risk and response" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Executive Insight", note: "Recommendation-led board story" },
      { name: "Transformation Map", note: "Operating model and change" },
      { name: "Thought Leadership", note: "Research and market narrative" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Industrial Precision", note: "Product and engineering rigor" },
      { name: "Smart Factory", note: "Automation and connected operations" },
      { name: "Quality Systems", note: "Standards, process and improvement" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Energy Infrastructure", note: "Assets, networks and capacity" },
      { name: "Grid Intelligence", note: "Operations and resilience" },
      { name: "Climate Transition", note: "Investment and decarbonization" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Performance Motion", note: "Emotion, speed and launch" },
      { name: "Engineering Precision", note: "Product detail and systems" },
      { name: "Future Mobility", note: "Connected, electric and autonomous" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Mission Systems", note: "Capability and readiness" },
      { name: "Aerospace Blueprint", note: "Engineering and integration" },
      { name: "Secure Briefing", note: "Controlled executive communication" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Connected Spectrum", note: "Network reach and experience" },
      { name: "Network Performance", note: "Capacity, latency and reliability" },
      { name: "Future Connectivity", note: "5G, edge and ecosystem" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Control Tower", note: "End-to-end operational view" },
      { name: "Route Network", note: "Movement, nodes and dependencies" },
      { name: "Operations Flow", note: "Process, exception and improvement" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Commerce Editorial", note: "Brand and product storytelling" },
      { name: "Product Marketplace", note: "Catalog, choice and utility" },
      { name: "DTC Campaign", note: "Conversion-led launch energy" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Shelf Impact", note: "Fast recognition and product energy" },
      { name: "Ingredient Story", note: "Origin, quality and craft" },
      { name: "Consumer Pulse", note: "Audience, occasions and growth" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Quiet Luxury", note: "Restraint, material and value" },
      { name: "Fashion Editorial", note: "Culture, silhouette and season" },
      { name: "Beauty Luminescence", note: "Macro detail and sensory light" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Premiere Cinematic", note: "Launch and emotional impact" },
      { name: "Broadcast System", note: "Programming and content structure" },
      { name: "Culture Collage", note: "Talent, audience and momentum" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Immersive World", note: "World, character and experience" },
      { name: "Esports Arena", note: "Competition, teams and broadcast" },
      { name: "Live-Ops Dashboard", note: "Engagement, content and economy" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Performance Kinetic", note: "Speed, effort and achievement" },
      { name: "Matchday Broadcast", note: "Schedule, stats and story" },
      { name: "Athlete Story", note: "Human performance and identity" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Destination Editorial", note: "Place, culture and discovery" },
      { name: "Hospitality Luxe", note: "Service, property and atmosphere" },
      { name: "Journey Story", note: "Itinerary, moments and experience" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Architectural Grid", note: "Structure, plan and context" },
      { name: "Property Gallery", note: "Space, material and value" },
      { name: "Urban Development", note: "Place, investment and impact" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Academic Clarity", note: "Readable, evidence-led teaching" },
      { name: "Learning Expressive", note: "Engagement and exploration" },
      { name: "Research Observatory", note: "Methods, findings and implications" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Civic Accessible", note: "Inclusive public communication" },
      { name: "Policy Brief", note: "Evidence, options and decision" },
      { name: "Public Data", note: "Transparent metrics and outcomes" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Impact Story", note: "Human change and purpose" },
      { name: "Documentary Report", note: "Evidence, context and accountability" },
      { name: "Outcomes Dashboard", note: "Targets, progress and proof" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "People & Culture", note: "Values, belonging and experience" },
      { name: "Talent Intelligence", note: "Skills, workforce and data" },
      { name: "Workplace Transformation", note: "Change, adoption and ways of working" },
    ],
  ...
  },
  {
    ...
    presets: [
      { name: "Immersive Event", note: "Atmosphere, destination and reveal" },
      { name: "Conference Intelligence", note: "Program, speakers and knowledge" },
      { name: "Sponsor Showcase", note: "Value, exposure and outcomes" },
    ],
