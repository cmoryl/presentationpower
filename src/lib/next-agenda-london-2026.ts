...
const DIGITAL_DAY_TWO: AgendaSession[] = [
  ...
  row("12:45-1:15 PM", "Amazon.com: Linguistic QA of Production Content", "Danielle Guenther, Amazon"),
...
const EXPERIENCE_DAY_ONE: AgendaSession[] = [
  ...
  row("3:50-4:20 PM", "Accessibility Is No Longer Optional: Designing Events Everyone Can Participate In", "Jaden Ellman, TRANSPERFECT"),
...
const GLOBALLINK_DAY_ONE: AgendaSession[] = [
  ...
  row("3:30-3:45 PM", "BREAK", "", { muted: true }),
  row("3:45-4:10 PM", "illycaffè: Brewing AI-Powered Innovation", "Speaker: Francesco Mandia, ILLYCAFFE", { parallels: [{ time: "3:45-4:15 PM", title: "Tripadvisor: Adapting to a New Era of Travel Discovery", detail: "Speaker: Ashley Jones, TRIPADVISOR", room: "ABBEY (4)" }] }),
  row("4:15-4:40 PM", "TP INTERNAL SESSION", "GL TV", { parallels: [{ time: "4:15 PM", title: "Built to Evolve: Redesigning Fairmont.com to Unlock the Future of Digital Hospitality", detail: "Speaker: Brittany Borrego, FAIRMONT", room: "ABBEY (4)" }] }),
...
const LEGAL_DAY_ONE: AgendaSession[] = [
  ...
  // The issued programme carried each room in brackets after the title. They are
  // recorded as rooms so every simultaneous card names the room it runs in.
  row("2:55-3:00 PM", "In-House | Roundtable", "", { room: "RUTHERFORD", parallels: [{ time: "2:55-3:00 PM", title: "Rising Stars | Panel", detail: "", room: "MOORE" }, { time: "2:55-3:00 PM", title: "Disclosure | Panel", detail: "", room: "WHITTLE" }] }),
