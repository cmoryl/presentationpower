...
export type TransitionType = "none" | "fade" | "push-left" | "push-right" | "zoom" | "cut";
...
export function seedContent(variantId: string, brief: Brief, sectionName: string): SlideContent {
  ...
  switch (variantId) {
    ...
    case "MV-OP-COVER-MEDIA":
      return {
        title: brief.meetingObjective || `${clientName} × TransPerfect`,
        subtitle: `A strategic partnership review`,
        clientName,
        date: new Date().toLocaleDateString(),
      };
        ...
        items: [
          {
            ...
            note: "Owns the relationship end to end.",
          },
          {
            name: "Priya Shah",
            role: "Solutions Lead",
            note: "Designs the program that fits your model.",
          },
          {
            name: "Marco Bianchi",
            role: "Delivery Lead",
            note: "Runs the day-to-day of the engagement.",
          },
        ],
      };
        ...
        items: [
          {
            ...
            body: "Content moves across teams and tools without a single source of truth, and each handoff introduces rework.",
          },
          {
            title: "Compliance drag",
            body: "Regulated markets add review steps that slow every launch and stretch time-to-market well past target.",
          },
        ],
      };
    case "MV-CTX-CARDS-3":
      return {
        ...
        items: [
          {
            title: "Fragmented workflows",
            body: "Content moves across teams and tools without a single source of truth.",
          },
          {
            title: "Rising volume",
            body: "Global content demand is outpacing the current review and QA capacity.",
          },
          {
            title: "Compliance drag",
            body: "Regulated markets add review steps that slow every launch.",
          },
        ],
      };
    case "MV-CTX-CARDS-4":
      return {
        ...
        items: [
          ...
          {
            title: "Compliance drag",
            body: "Regulated markets add review steps that slow launches.",
          },
          {
            title: "Cost visibility",
            body: "Program spend is hard to tie back to business outcomes.",
          },
        ],
      };
    case "MV-CTX-COST":
      return {
        ...
        narrative:
          "Every quarter of delay in a regulated market compounds into lost revenue and audit exposure.",
      };
    ...
    case "MV-CTX-TREND":
      return {
        direction: "up",
        headline:
          "Regulated content volume is outpacing every localization program built before 2022.",
        narrative:
          "Volume is up, deadlines are compressed, and reviewers are the bottleneck. The programs pulling ahead have re-designed intake and QA — not just added headcount.",
      };
        ...
        items: [
          {
            ...
            body: "Every step between briefing, translation, and review re-explains the same requirements.",
          },
          {
            title: "Reviewers are the bottleneck",
            body: "In-market reviewers are asked to catch too much, too late.",
          },
          {
            title: "Reporting is manual",
            body: "Program leaders assemble status decks from spreadsheets each week.",
          },
        ],
      };
    ...
    case "MV-INS-CALLOUT":
      return {
        ...
        narrative: `${clientName} has the linguistic talent — what's missing is the connective tissue between briefing, review, and publish.`,
      };
    case "MV-INS-BIG-IDEA":
      return {
        kicker: "The big idea",
        idea: "Treat localization as a supply chain, not a service.",
      };
    case "MV-INS-SO-WHAT":
      return {
        ...
        items: [
          {
            ...
            body: "One request surface across content types and markets, with the brief carried through every step of the workflow.",
          },
          {
            title: "AI-assisted review",
            body: "Model-in-the-loop QA that keeps your specialists focused on the exceptions, not the routine.",
          },
        ],
      };
    case "MV-SOL-PILLARS-3":
      return {
        ...
        items: [
          {
            title: "Unified intake",
            body: "One request surface across content types and markets.",
          },
          {
            title: "AI-assisted review",
            body: "Model-in-the-loop QA that keeps humans on the exceptions.",
          },
          {
            title: "Governed publish",
            body: "Approved-only output routed to the right channels automatically.",
          },
        ],
      };
    ...
    case "MV-SOL-PILLARS-5":
      return {
        ...
        hero: {
          title: "Unified intake",
          body: "One request surface that carries your brief and rules through every downstream step.",
        },
        items: [
          { title: "Translation", body: "150+ languages, subject-matter matched." },
        ...
        items: [
          {
            ...
            body: "Intake, review, and status surfaces for requesters and reviewers.",
          },
          {
            label: "Workflow engine",
            body: "Routing, SLAs, and approvals across content types and markets.",
          },
          {
            label: "AI + language services",
            body: "Translation, QA, and terminology enforcement.",
          },
          {
            label: "Integrations",
            body: "CMS, DAM, PIM, and channel systems your teams already use.",
          },
        ],
      };
    ...
    case "MV-PROC-PHASES":
      return {
        ...
        items: [
          {
            label: "Discover",
            body: "Two-week intake mapping across the priority content types and markets.",
          },
          {
            label: "Pilot",
            body: "One market, one content type — measurable results in a single quarter.",
          },
          {
            label: "Scale",
    ...
    case "MV-PROC-BEFORE-AFTER":
      return {
        title: "What changes",
        before: {
          title: "Requests scattered across tools",
          body: "Each team files requests differently, reviewers see files without context, and status lives in spreadsheets.",
        },
        after: {
          title: "One intake, one workflow",
        ...
        items: [
          {
            ...
            source: "TransPerfect benchmark, 2025",
          },
          {
            value: "22",
            unit: "%",
            label: "lower cost per project",
            source: "Client rollout, 2024",
          },
        ],
      };
        ...
        items: [
          {
            ...
            unit: "%",
            label: "faster time to market",
            source: "TransPerfect enterprise benchmark, 2025",
          },
          {
            value: "22",
            unit: "%",
            label: "lower total cost of content",
            source: "Client rollout, 2024",
          },
          {
            value: "99.5",
            ...
            source: "Managed program data, 2025",
          },
        ],
      };
    ...
    case "MV-DEC-CHECKLIST":
      return {
        ...
        items: [
          {
            label: "Reduces cycle time in a measurable window",
            note: "Signal by end of quarter one.",
          },
          {
            label: "Doesn't require growing the review team",
            note: "AI-assisted QA carries the routine load.",
          },
          { label: "Fits your existing CMS and DAM", note: "No system-of-record replacement." },
          {
            label: "Meets regulated-market audit needs",
            note: "Full traceability of every change.",
          },
        ],
      };
        ...
        items: [
          {
            ...
            price: "$45k",
            unit: "one quarter",
            features: ["1 market", "1 content type", "SLA on QA", "Program readout"],
          },
          {
            name: "Program",
            price: "$220k",
    ...
    case "MV-RISK-MITIGATION":
      return {
        ...
        items: [
          {
            risk: "Pilot doesn't hit its cycle-time target",
            mitigation:
              "Weekly checkpoints in month one; scope adjustment built into the pilot SOW.",
          },
          {
            risk: "Reviewer adoption lags",
            mitigation: "In-product coaching and a named change lead assigned in week one.",
          },
          {
            risk: "Integration takes longer than planned",
            mitigation: "Parallel-run mode; program runs before full integration completes.",
          },
        ],
      };
        ...
        items: [
          {
            name: "Alex Rivera",
            role: "Account Director",
            bio: "12 years running enterprise language programs across regulated industries.",
          },
          {
            name: "Priya Shah",
            role: "Solutions Lead",
            bio: "Designs the operating model that fits your review, tooling, and audit needs.",
          },
          {
            name: "Marco Bianchi",
            role: "Delivery Lead",
            bio: "Owns the day-to-day of the program and the SLA you see in the dashboard.",
          },
        ],
      };
    case "MV-TEAM-BIOS-4":
        ...
        items: [
          {
            name: "Alex Rivera",
            role: "Account Director",
            bio: "Owns the relationship and the roadmap.",
          },
          { name: "Priya Shah", role: "Solutions Lead", bio: "Designs the operating model." },
          {
            name: "Marco Bianchi",
            role: "Delivery Lead",
            bio: "Runs the day-to-day of the program.",
          },
          {
            name: "Sara Kim",
            role: "Language Ops Lead",
            bio: "Owns linguistic quality across markets.",
          },
        ],
      };
    case "MV-GOV-RACI":
      return {
        ...
        items: [
          {
            forum: "Weekly stand-up",
            cadence: "Weekly · 30 min",
            purpose: "Delivery status, blockers, next-week plan.",
          },
          {
            forum: "Monthly steering",
            cadence: "Monthly · 60 min",
            purpose: "Program KPIs, escalations, upcoming market changes.",
          },
          {
            forum: "Quarterly business review",
            cadence: "Quarterly · 90 min",
            purpose: "Outcomes vs. targets, roadmap, investment decisions.",
          },
        ],
      };
    ...
    case "MV-REC-NEXT":
      return {
        recommendation: `We recommend ${clientName} start with a focused pilot in the highest-volume market.`,
        rationale:
          "This isolates the workflow change, produces measurable results in one quarter, and de-risks the enterprise rollout.",
      };
    case "MV-CLOSE-CTA":
      return {
    ...
    case "MV-CLOSE-QNA":
      return {
        title: "Questions",
        prompt: "Open discussion — what's the piece you'd want to pressure-test first?",
      };
        ...
        items: [
          {
            name: "Alex Rivera",
            role: "Account Director",
            email: "alex.rivera@transperfect.com",
            phone: "+1 212 555 0123",
          },
          {
            name: "Priya Shah",
            role: "Solutions Lead",
            email: "priya.shah@transperfect.com",
    ...
    case "MV-OP-COVER-EDITORIAL":
      return {
        kicker: `Vol. 01 · ${brief.industry || "Enterprise"}`,
        title: brief.meetingObjective || `A conversation with ${clientName}`,
        subtitle: `An editorial briefing for ${clientName}.`,
        clientName,
        date: new Date().toLocaleDateString(),
        mediaSeed: `${clientName}-editorial`,
      };
    case "MV-OP-COVER-SPLIT":
      return {
        title: `${clientName} × TransPerfect`,
        subtitle: brief.meetingObjective || "A partnership review.",
        clientName,
        date: new Date().toLocaleDateString(),
        mediaSeed: `${clientName}-split`,
      };
    case "MV-OP-COVER-POSTER":
      return {
        kicker: `A briefing for ${clientName}`,
        title: (brief.meetingObjective || "Signal").split(" ").slice(0, 2).join(" ") || "Signal",
        meta: `${brief.industry || "Global"} · Confidential`,
      };
    ...
    case "MV-OP-COVER-DOSSIER":
      return {
        reference: `TP-${Date.now().toString().slice(-4)}`,
        title: brief.meetingObjective || `${clientName} engagement dossier`,
        clientName,
        prepared: "TransPerfect",
        date: new Date().toLocaleDateString(),
      };
    case "MV-OP-COVER-GRADIENT":
      return {
        title: brief.meetingObjective || clientName,
        subtitle: `A strategic conversation with ${clientName}.`,
        clientName,
        date: new Date().toLocaleDateString(),
      };
    case "MV-OP-COVER-MONOGRAM":
      return {
        monogram: clientName.slice(0, 2).toUpperCase(),
        title: brief.meetingObjective || clientName,
    ...
    case "MV-OP-COVER-STACKED":
      return {
        kicker: `A proposal for ${clientName}`,
        title: brief.meetingObjective || "The path forward",
        subtitle: "Prepared by TransPerfect",
        date: new Date().toLocaleDateString(),
        mediaSeed: `${clientName}-stacked`,
      };
    ...
    case "MV-IMG-FULL-BLEED":
      return {
        kicker: "In focus",
        title: "Content moves at the speed of your program.",
        body: "Every asset, every market, every review — one connected flow.",
        mediaSeed: `${clientName}-fullbleed`,
      };
    case "MV-IMG-SPLIT":
      return {
        title: `Built around how ${clientName} works today`,
        body: "We start with the workflow you already run and add the connective tissue — intake, terminology, and reviewer context — so your team gets time back on day one.",
        caption: "Fieldwork · 2025",
        mediaSeed: `${clientName}-workflow`,
      };
    case "MV-IMG-CAPTION":
      return {
        title: "In focus",
        caption: "The reviewer workbench: source brief, translation, and rules in one view.",
        credit: "Product · v3.4",
    ...
    case "MV-IMG-PORTRAIT":
      return {
        ...
        narrative:
          "12 years running enterprise language programs across regulated industries. Alex owns the relationship end to end and is your single point of accountability across the engagement.",
    ...
    case "MV-IMG-BEFORE-AFTER":
      return {
        ...
        before: {
          label: "Scattered intake",
          body: "Requests in email, spreadsheets, and side channels.",
          seed: "before-scene",
        },
        after: {
          label: "One workflow",
          body: "Every request carries its brief and rules through review.",
          seed: "after-scene",
        },
      };
    case "MV-IMG-STAT-CALLOUT":
      return {
        ...
        narrative: `${clientName} teams shipped in half the time on the pilot workflow — with the same reviewer headcount.`,
        mediaSeed: `${clientName}-stat`,
      };
    case "MV-IMG-STRIP":
      return {
        title: "A quick look",
    ...
    case "MV-QUOTE-MULTI":
      return {
        ...
        items: [
          {
            quote: "They cut our launch cycle nearly in half without adding a reviewer.",
            attribution: "VP, Global Marketing",
            role: "Life sciences",
          },
          {
            quote: "The first program where reviewers had context on day one.",
            attribution: "Head of Regulatory",
            role: "Global bank",
          },
          {
            quote: "One workflow across 14 languages — status finally lives in one place.",
            attribution: "Director, Content Ops",
            role: "Consumer tech",
          },
        ],
      };
    ...
    case "MV-INFO-FUNNEL":
      return {
        ...
        items: [
          ...
          {
            label: "Approved for translation",
            value: "9,800",
            unit: "assets",
            note: "79% conversion",
          },
          ...
          {
            label: "Published in-market",
            value: "8,600",
            unit: "assets",
            note: "97% of QA-passed",
          },
        ],
      };
    ...
    case "MV-CLIENT-MATRIX":
      return {
        ...
        items: [
          {
            client: "Life sciences leader",
            sector: "Pharma",
            result: "Faster regulated launches",
            metric: "38",
            unit: "%",
          },
          {
            ...
            result: "Reg comms across 22 markets",
            metric: "22",
            unit: "markets",
          },
          {
            ...
            sector: "Technology",
            result: "Launch parity across 14 languages",
            metric: "14",
            unit: "langs",
          },
          {
            client: "Retail group",
            sector: "Retail",
            result: "Lower content cost, same coverage",
            metric: "24",
            unit: "% ↓",
          },
          {
            ...
            sector: "Insurance",
            result: "Audit-ready in every market",
            metric: "0",
            unit: "findings",
          },
          {
            ...
            sector: "Automotive",
            result: "Model launches on one timeline",
            metric: "1",
            unit: "cadence",
          },
        ],
        ...
        items: [
          {
            client: "Life-sciences leader",
            sector: "Pharma · EU + US",
            story: "Moved from 28 vendors to one program across regulated documents in 28 markets.",
            metric: "38% ↓ launch time",
            seed: "life-sci",
          },
          {
            client: "Global bank",
            sector: "Financial services",
            story: "Regulator-ready comms rolled out across 22 markets on a single workflow.",
          ...
          },
          {
            client: "Consumer tech",
            sector: "Technology",
            story: "Product, marketing, and support content shipped in parity across 14 languages.",
            metric: "14 langs, one release",
            seed: "tech",
          },
        ],
      };
    case "MV-IMG-MATRIX-4":
      return {
        ...
        items: [
          {
            label: "Intake",
            body: "One brief carries every downstream step.",
            seed: "matrix-intake",
          },
          {
            label: "Translate",
            body: "Subject-matter matched across 150+ languages.",
            seed: "matrix-translate",
          },
          {
            label: "Review",
            body: "Context follows the file into the workbench.",
            seed: "matrix-review",
          },
          {
            label: "Publish",
            body: "Approved-only output routed to channels.",
            seed: "matrix-publish",
          },
        ],
      };
    case "MV-IMG-MATRIX-6":
      return {
        ...
        items: [
          ...
          {
            label: "Regulatory",
            body: "Audit-ready regulated content.",
            seed: "matrix-regulatory",
          },
    ...
    case "MV-CLIENT-COMPARE":
      return {
        ...
        items: [
          {
            client: "Life-sciences leader",
            challenge: "28 vendors, no shared context, launches slipping every quarter.",
            outcome: "One managed program with AI-assisted QA and single intake.",
            metric: "38% ↓ launch time",
          },
          {
            client: "Global bank",
            challenge: "Regulator comms drifting out of parity across 22 markets.",
            outcome: "Governed workflow with terminology enforcement at the source.",
            metric: "0 audit findings",
          },
          {
            client: "Consumer tech",
            challenge: "Product, marketing, and support content out of sync across languages.",
            outcome: "One release cadence across 14 languages with live SLA dashboards.",
            metric: "14 langs, one release",
          },
        ],
      };
    ...
    case "MV-CLOSE-TIMELINE":
      return {
        ...
        items: [
          {
            label: "First 30 days",
            body: "Discovery, intake mapping, and pilot scope locked.",
            owner: "TransPerfect + Client PM",
          },
          {
            label: "60 days",
            body: "Pilot live in one market — first measurable results.",
            owner: "Delivery Lead",
          },
          {
            label: "90 days",
            body: "Readout, decision on scale, program SOW.",
    ...
    case "MV-CLOSE-DECISION":
      return {
        ...
        rationale:
          "One quarter, one market, one content type — enough signal to decide on the full program with data, not hypothesis.",
        ...
        items: [
          {
            ...
            note: "$45k · one quarter",
          },
          {
            label: "Program",
            body: "Full managed program across the portfolio, with governance and analytics in place.",
            ctaLabel: "Scope the program",
            note: "$220k · annualized",
          },
        ],
      };
      ...
      return {
        ...
        items: [
          ...
          { kind: "stat", icon: "Timer", value: "62", unit: "%", label: "Faster launch cycles" },
          {
            ...
            icon: "Cpu",
            title: "Human + AI",
            body: "Reviewer network paired with adaptive MT — quality that survives audit, at the speed of publish.",
          },
    ...
    case "MV-ROADMAP-QUARTERS":
      return {
        ...
        items: [
          {
            label: "Discovery & terminology base",
            start: 1,
            end: 1,
            note: "Voice, glossaries, priority markets",
          },
          ...
          {
            label: "AI-assisted expansion",
            start: 3,
            end: 4,
            note: "Adaptive MT + reviewer network",
          },
    ...
    case "MV-FUNNEL":
      return {
        ...
        items: [
          {
            icon: "Sparkles",
            label: "Content produced at HQ",
            value: "100",
            unit: "%",
            note: "Original creative in source language",
          },
          {
            icon: "Send",
            label: "Translated on time",
            value: "68",
            unit: "%",
            note: "Rest slips a full cycle",
          },
          {
            icon: "FileCheck2",
            label: "Reviewed in-market",
            value: "44",
            unit: "%",
            note: "Local voice check",
          },
          {
            icon: "Trophy",
            label: "Published on brand",
            value: "31",
            unit: "%",
            note: "Meeting compliance + tone",
          },
        ],
      };
    case "MV-FLYWHEEL":
      ...
      return {
        ...
        items: [
          { icon: "Search", phase: "Discover", touchpoint: "Paid + organic search", sentiment: 2 },
          {
            icon: "ClipboardList",
            phase: "Evaluate",
            touchpoint: "Product pages, docs",
            sentiment: 3,
          },
          {
            icon: "Handshake",
            phase: "Decide",
            touchpoint: "Sales, legal, compliance",
            sentiment: 2,
          },
    ...
    case "MV-MATRIX-2X2":
      return {
        ...
        quadrants: [
          ...
          "Boutique agencies",
          "In-house teams",
          "TransPerfect program",
        ],
        target: 4,
        items: [
          { label: "Legacy LSP", x: 0.25, y: 0.3 },
          { label: "Boutique", x: 0.3, y: 0.72 },
          { label: "In-house", x: 0.55, y: 0.55 },
          { label: `${clientName} today`, x: 0.45, y: 0.48 },
          { label: "TransPerfect", x: 0.8, y: 0.82 },
        ],
      };
    case "MV-ICEBERG":
      return {
        ...
        above: [
          { icon: "Coins", label: "Vendor invoices", body: "The line item everyone tracks." },
          {
            icon: "Timer",
            label: "Cycle time",
            body: "Weeks between HQ launch and in-market live.",
          },
        ],
        below: [
          {
            icon: "Wrench",
            label: "Rework in-market",
            body: "Local teams re-editing off-brand copy.",
          },
          {
            icon: "AlertTriangle",
            label: "Compliance risk",
            body: "Regulated content published without terminology control.",
          },
          {
            icon: "TrendingUp",
            label: "Lost revenue",
            body: "Campaigns that miss the local season entirely.",
          },
          {
            icon: "MessagesSquare",
            label: "Brand drift",
            body: "Voice fragments across every market and channel.",
          },
        ],
      };
    ...
    case "MV-EDITORIAL-SPREAD":
      return {
        ...
        bodyRight:
          "The programs that win treat localization as an operating capability: shared voice, adaptive AI, a reviewer network in every market, and analytics that close the loop back to source content. That's the shift this deck argues for.",
    ...
    case "MV-SPLIT-MANIFESTO":
      return {
        ...
        items: [
          {
            title: "One operating model",
            body: "A single program across every market, content type, and channel.",
          },
          {
            title: "Human + AI",
            body: "Adaptive machine translation paired with an in-market reviewer network.",
          },
          {
            title: "Governance-ready",
            body: "Terminology, voice, and regulatory guardrails codified per market.",
          },
        ],
      };
        ...
        items: [
          {
            ...
            note: "Source-to-market in one quarter, not three.",
            source: "TransPerfect program benchmarks",
          },
          {
            value: "38",
            unit: "M",
            label: "Words per year",
            note: "Delivered under one governance model.",
            source: `${clientName} pilot forecast`,
          },
          {
            value: "97.4",
            unit: "%",
            label: "On-time in-market",
            note: "Across every market and content type.",
            source: "12-month rolling avg.",
          },
        ],
      };
        ...
        items: [
          {
            date: "Wk 1–2",
            label: "Discovery",
            body: "Voice profile, glossary base, priority markets and content types.",
          },
          {
            date: "Wk 3–6",
            label: "Pilot",
          ...
          },
          {
            ...
            body: "Extend to remaining priority markets under one governance model.",
          },
          {
            date: "Mo 6–12",
            label: "AI expansion",
            body: "Adaptive MT + reviewer network unlocked across the portfolio.",
          },
          {
            date: "Yr 2+",
            label: "Optimized",
            body: "Real-time in-market, feedback loop to source, program-wide analytics.",
          },
        ],
      };
    ...
    case "MV-COMPARE-SLIDER":
      return {
        ...
        before: {
          label: "Before — vendor per market",
          value: "84",
          unit: "d",
          body: "Average cycle from HQ launch to in-market live, across 12 vendors.",
        },
        after: {
          label: "After — TransPerfect program",
          value: "31",
          unit: "d",
          body: "One operating model, adaptive MT + in-market reviewers, live SLA telemetry.",
        },
      };
    case "MV-PULL-QUOTE-STACK":
      return {
        ...
        items: [
          {
            quote: "Regulatory content that used to take a quarter is now weeks.",
            name: "Head of Regulatory",
            role: "Life Sciences",
            org: "Global pharma",
          },
          {
            quote: "Our reviewer network is finally an asset, not a bottleneck.",
    ...
    case "MV-DEFINITION":
      return {
        ...
        partOfSpeech: "n.",
        definition:
          "The operating discipline of publishing one brand voice across every market at source-speed, with the terminology, regulatory, and cultural fidelity a local audience expects.",
    ...
    case "MV-PRINCIPLES":
      return {
        ...
        items: [
          {
            statement: "One voice, everywhere.",
            body: `Every market speaks ${clientName} — not a translated approximation of it.`,
          },
          {
            statement: "Human decides, AI accelerates.",
            body: "Adaptive MT handles volume; the reviewer network owns brand and compliance.",
          },
          {
            statement: "Governance is the substrate.",
            body: "Terminology, tone, and regulatory rules live in one place, per market.",
          },
          {
            statement: "Signal, not opinion.",
            body: "Program SLAs, cycle times, and quality scores steer the next quarter's plan.",
          },
        ],
      };
    case "MV-COUNTDOWN":
      return {
        ...
        items: [
          {
            statement: "One program, every market.",
            body: "Not a vendor stack — an operating model.",
          },
          {
            statement: "Human + AI, on your voice.",
            body: "Adaptive MT trained on your terminology and tone.",
          },
          {
            statement: "Measurable in one quarter.",
            body: "Pilot in a priority market, decide with data.",
          },
        ],
      };
    case "MV-HORIZON":
      return {
        ...
        items: [
          {
            label: "Now",
            headline: "Pilot in one priority market",
            body: "Two-week discovery, then live in one market and one content type inside a quarter.",
          },
          {
            label: "Next",
            headline: "Program rollout",
            body: "Extend to the remaining priority markets under one governance model.",
          },
          {
            label: "Later",
            headline: "AI-assisted expansion",
            body: "Adaptive MT + reviewer network unlocked across the full portfolio with real-time telemetry.",
          },
        ],
      };
    ...
    case "MV-DASH-SUMMARY":
      return {
        ...
        primary: {
          ...
          value: "1.24",
          unit: "M",
          series: [42, 51, 48, 60, 66, 71, 78],
        },
        secondary: {
          label: "Cost avoided vs. legacy",
          value: "$284",
          unit: "K",
          series: [30, 32, 41, 45, 48, 52, 58],
        },
        balance: {
          value: "97.4",
          unit: "%",
        ...
        items: [
          {
            label: "On-time delivery",
            value: 97,
            body: "Across 38 live markets and 6 content types.",
          },
          {
            label: "In-market approval",
            value: 94,
            body: "Reviewer first-pass approval, trailing 90 days.",
          },
          {
            label: "MT quality (est.)",
            value: 88,
            body: "Adaptive MT trained on your terminology.",
          },
        ],
      };
    ...
    case "MV-DASH-REPORT-CARDS":
      return {
        ...
        items: [
          {
            delta: "+2.4M words",
            label: "Volume growth vs. prior quarter",
            meta: "38 markets / 6 content types",
            series: [21, 24, 28, 31, 34, 38, 42],
          },
          {
            delta: "-4 days",
            label: "Avg. cycle time reduction",
            meta: "Since adaptive MT rollout",
            series: [22, 20, 19, 17, 15, 13, 12],
          },
        ],
      };
        ...
        items: [
          {
            ...
            body: "Legacy vendor mix, human-only workflow.",
            meta: "2023",
          },
          {
            value: 94,
            label: "First-pass approval",
            body: "Adaptive MT + reviewer network, tuned to your terminology.",
            meta: "2026",
          },
        ],
      };
      ...
      return {
        ...
        items: [
          { label: "Markets onboarded", done: 32, total: 38, body: "6 remaining in EMEA rollout." },
          {
            ...
            total: 10000,
            body: "Glossary coverage across content types.",
          },
          {
            label: "Reviewer training",
            done: 71,
            total: 100,
            body: "Localized reviewers certified to v3 brand voice.",
          },
        ],
      };
    case "MV-GRAPH-DECADE-AREA":
      return {
        ...
        series: [
          { label: "2017", value: 1.1 },
          { label: "2018", value: 1.4 },
          { label: "2019", value: 1.7 },
      ...
      return {
        ...
        items: [
          { label: "On-time delivery", current: 97, benchmark: 84, range: "Industry band: 78–89%" },
          {
            ...
            current: 94,
            benchmark: 76,
            range: "Industry band: 68–82%",
          },
          {
            label: "Terminology adherence",
            current: 91,
            benchmark: 72,
            range: "Industry band: 61–78%",
          },
          {
            label: "Reviewer utilization",
            current: 82,
            benchmark: 65,
            range: "Industry band: 55–70%",
          },
        ],
      };
      ...
      return {
              ...
              [deckId]: {
                ...
                slides: deck.slides.map((sl) => {
                  ...
                  return {
                    ...
                    changes: [
                      ...sl.changes.filter((c) => !changes.find((n) => n.field === c.field)),
                      ...changes,
                    ],
                  };
                }),
        ...
        updateSlideField: (deckId, slideId, field, value) => {
          ...
          const isArrayRootWrite =
            Array.isArray(value) && variant.editableFields.some((f) => f.startsWith(`${field}[]`));
          const editable =
                    ...
                    ? {
                        ...
                        content:
                          background === null || background === undefined
                            ? (() => {
                                const { background: _drop, ...rest } = sl.content as Record<
                                  string,
                                  unknown
                                >;
                            ...
                            : ({
                                ...(sl.content as Record<string, unknown>),
                                background,
                              } as SlideContent),
                      }
                    : sl,
          ...
          set((s) => ({
            decks: {
              ...
              [deckId]: {
                ...deck,
                slides: deck.slides.map((sl) =>
                  sl.id === slideId ? { ...sl, transition: transition ?? undefined } : sl,
                ),
              },
            },
          }));
        ...
        swapVariant: (deckId, slideId, newVariantId, source) => {
          ...
          const sectionName =
            SECTION_FRAMEWORKS.find((sf) => sf.id === slide.sectionId)?.name ?? "";
          ...
          if (variantSupportsVideo(newVariantId)) {
            ...
            if (typeof prev.videoPosterUrl === "string")
              merged.videoPosterUrl = prev.videoPosterUrl;
            if (typeof prev.videoPath === "string") merged.videoPath = prev.videoPath;
            if (typeof prev.videoPosterPath === "string")
              merged.videoPosterPath = prev.videoPosterPath;
            for (const k of [
              "videoAutoplay",
              "videoLoop",
              "videoMuted",
        ...
        addSlide: (deckId, sectionId, afterSlideId) => {
          ...
          const idx = afterSlideId
            ? deck.slides.findIndex((sl) => sl.id === afterSlideId)
        ...
        insertVariantSlide: (deckId, variantId) => {
          ...
          track({
            ...
            slideId: newSlide.id,
            variantId: variant.id,
            moduleFamily: variant.familyId,
            props: { source: "insertVariant" },
          });
        ...
        duplicateSlide: (deckId, slideId) => {
          ...
          const next = [...deck.slides.slice(0, idx + 1), copy, ...deck.slides.slice(idx + 1)].map(
            (sl, i) => ({ ...sl, position: i }),
          );
          set((s) => ({ decks: { ...s.decks, [deckId]: { ...deck, slides: next } } }));
          track({
          ...
          const deck: Deck = {
            ...
            slides: payload.slides.map((s, i) => {
              ...
              const resolvedLayoutId =
                (s.layoutId && mv?.permittedLayoutIds.includes(s.layoutId)
                  ? s.layoutId
                  : undefined) ??
