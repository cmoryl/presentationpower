...
const pl = (x: number, y: number, w: number, h: number, fill = PLATE, radius = 24): PresetPart => ({
  type: "surface",
  x,
  y,
  w,
  h,
  props: { fill, radius, opacity: 1 },
});
...
const head = (text: string): PresetPart => tx(160, 130, 1600, 110, text, { size: 64, weight: 700 });
...
const PROCESS_PRESETS: BlockPreset[] = [
    ...
    parts: [
      ...
      ...[0, 1, 2, 3].flatMap((i) => {
        ...
        return [
          ...
          tx(x + 40, 520, 300, 170, "One line on what happens in this step and who owns it.", {
            size: 24,
          }),
          ...(i < 3 ? [arrow(x + 390, 550)] : []),
        ];
  ...
  },
  {
    ...
    parts: [
      ...
      ...[0, 1, 2, 3].map((i) =>
        kk(480 + i * 340, 300, 300, ["Intake", "Prepare", "Deliver", "Verify"][i]!),
      ),
      ...[0, 1, 2].flatMap((r) => {
        const y = 370 + r * 170;
        ...
        return [
          ...
          ...[0, 1, 2, 3].map((c) =>
            tx(510 + c * 340, y + 30, 240, 90, "Step detail", { size: 24 }),
          ),
        ];
      }),
    ],
  ...
  },
  {
    ...
    parts: [
      ...
      tx(210, 480, 380, 250, "Source content, terminology, briefs and reference material.", {
        size: 26,
      }),
      arrow(680, 540),
    ...
    parts: [
      ...
      ...[0, 1, 2, 3, 4].flatMap((i) => {
        ...
        return [
          ...
          tx(x, 540, 300, 200, "One line on the activity and the artefact it produces.", {
            size: 23,
          }),
        ];
      }),
      tx(160, 800, 1640, 60, "Testing feeds straight back into empathy — the loop never closes.", {
        size: 26,
      }),
    ],
  },
  ...
  },
  {
    ...
    parts: [
      ...
      tx(260, 800, 1400, 80, "Name what each tier depends on beneath it.", {
        size: 26,
        align: "center",
      }),
    ],
  ...
  // ---------------------------------------------------------------- text
  {
    ...
    parts: [
      { type: "text", x: 160, y: 300, w: 900, h: 40, props: kicker() },
      {
        ...
        h: 220,
        props: {
          text: "A headline that carries the slide",
          size: 96,
          weight: 700,
          align: "left",
          color: INK,
  ...
  },
  {
    ...
    parts: [
      ...
      },
      {
        ...
        h: 180,
        props: {
          text: "Two or three lines of supporting copy that explain the idea without crowding the slide.",
          size: 34,
          weight: 400,
          align: "left",
          color: INK,
  ...
  },
  {
    ...
    parts: [
      ...
      },
      {
        ...
        h: 260,
        props: {
          text: "Left column copy. Keep each column to three or four lines so the slide stays readable when projected.",
          size: 32,
          weight: 400,
          align: "left",
          color: INK,
      ...
      },
      {
        ...
        h: 260,
        props: {
          text: "Right column copy. Mirror the length of the left column to keep the composition balanced.",
          size: 32,
          weight: 400,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        h: 240,
        props: {
          text: "The one sentence they remember",
          size: 104,
          weight: 700,
          align: "center",
          color: INK,
    ...
    parts: [
      {
        ...
        h: 260,
        props: {
          text: "“A quote that lands, kept short enough to read in one breath.”",
          size: 72,
          weight: 600,
          align: "left",
          color: INK,
  ...
  },
  {
    ...
    parts: [
      ...
      { type: "text", x: 720, y: 380, w: 480, h: 60, props: kicker({ text: "02 · Design" }) },
      {
        ...
        h: 180,
        props: {
          text: "Short description of the second step.",
          size: 30,
          weight: 400,
          align: "left",
          color: INK,
      ...
      { type: "text", x: 1280, y: 380, w: 480, h: 60, props: kicker({ text: "03 · Deliver" }) },
      {
        ...
        h: 180,
        props: {
          text: "Short description of the third step.",
          size: 30,
          weight: 400,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        w: 480,
        h: 260,
        props: { value: "92%", label: "Describe the metric", surface: "plate", accent: ACCENT },
      },
      {
        type: "stat",
        x: 720,
        ...
        w: 480,
        h: 260,
        props: { value: "3.4x", label: "Describe the metric", surface: "plate", accent: ACCENT },
      },
      {
        type: "stat",
        x: 1280,
        ...
        w: 480,
        h: 260,
        props: { value: "48h", label: "Describe the metric", surface: "plate", accent: ACCENT },
      },
    ],
  },
  {
    ...
    parts: [
      {
        ...
        w: 780,
        h: 420,
        props: { value: "92%", label: "The headline metric", surface: "plate", accent: ACCENT },
      },
      {
        type: "stat",
        x: 1000,
        ...
        w: 760,
        h: 200,
        props: { value: "3.4x", label: "Supporting metric", surface: "bare", accent: ACCENT },
      },
      {
        type: "stat",
        x: 1000,
        ...
        w: 760,
        h: 200,
        props: { value: "48h", label: "Supporting metric", surface: "bare", accent: ACCENT },
      },
    ],
  },
  {
    ...
    parts: [
      {
        ...
        h: 300,
        props: {
          text: "Why these numbers matter, in two or three short lines.",
          size: 34,
          weight: 400,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        w: 720,
        h: 230,
        props: { value: "92%", label: "Metric one", surface: "plate", accent: ACCENT },
      },
      {
        type: "stat",
        x: 1000,
        ...
        w: 720,
        h: 230,
        props: { value: "3.4x", label: "Metric two", surface: "plate", accent: ACCENT },
      },
      {
        type: "stat",
        x: 200,
        ...
        w: 720,
        h: 230,
        props: { value: "48h", label: "Metric three", surface: "plate", accent: ACCENT },
      },
      {
        type: "stat",
        x: 1000,
        ...
        w: 720,
        h: 230,
        props: { value: "120+", label: "Metric four", surface: "plate", accent: ACCENT },
      },
    ],
  },
    ...
    parts: [
      {
        ...
        h: 140,
        props: {
          text: "Headline beside the image",
          size: 72,
          weight: 700,
          align: "left",
          color: INK,
      ...
      },
      {
        ...
        h: 200,
        props: {
          text: "Supporting copy that gives the image context.",
          size: 32,
          weight: 400,
          align: "left",
          color: INK,
      ...
      },
      {
        ...
        w: 780,
        h: 640,
        props: { fit: "cover", radius: 32, alt: "Replace this imagery" },
      },
    ],
  },
  {
    ...
    parts: [
      {
        ...
        w: 500,
        h: 340,
        props: { fit: "cover", radius: 24, alt: "Frame one" },
      },
      {
        type: "text",
        x: 160,
        ...
        w: 500,
        h: 70,
        props: { text: "Caption one", size: 26, weight: 500, align: "left", color: INK },
      },
      {
        type: "image",
        x: 710,
        ...
        w: 500,
        h: 340,
        props: { fit: "cover", radius: 24, alt: "Frame two" },
      },
      {
        type: "text",
        x: 710,
        ...
        w: 500,
        h: 70,
        props: { text: "Caption two", size: 26, weight: 500, align: "left", color: INK },
      },
      {
        type: "image",
        x: 1260,
        ...
        w: 500,
        h: 340,
        props: { fit: "cover", radius: 24, alt: "Frame three" },
      },
      {
        type: "text",
        x: 1260,
        ...
        w: 500,
        h: 70,
        props: { text: "Caption three", size: 26, weight: 500, align: "left", color: INK },
      },
    ],
  },
  {
    ...
    parts: [
      {
        ...
        w: 1920,
        h: 620,
        props: { fit: "cover", radius: 0, alt: "Hero imagery" },
      },
      {
        type: "surface",
        x: 0,
        ...
        w: 1920,
        h: 120,
        props: { fill: INK, radius: 0, opacity: 1 },
      },
      {
        type: "text",
        x: 160,
    ...
    parts: [
      {
        ...
        w: 560,
        h: 640,
        props: { fit: "cover", radius: 28, alt: "Portrait" },
      },
      {
        type: "text",
        x: 820,
        ...
        h: 280,
        props: {
          text: "“A short quote from the person pictured.”",
          size: 60,
          weight: 600,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        w: 940,
        h: 620,
        props: { fit: "cover", radius: 28, alt: "Lead image" },
      },
      {
        type: "image",
        x: 1140,
        ...
        w: 620,
        h: 295,
        props: { fit: "cover", radius: 24, alt: "Detail one" },
      },
      {
        type: "image",
        x: 1140,
        ...
        w: 620,
        h: 295,
        props: { fit: "cover", radius: 24, alt: "Detail two" },
      },
    ],
  },
    ...
    parts: [
      {
        ...
        w: 1180,
        h: 480,
        props: { fill: PLATE, radius: 36, opacity: 1 },
      },
      {
        type: "text",
        x: 240,
        ...
        w: 1020,
        h: 160,
        props: { text: "Headline on a plate", size: 80, weight: 700, align: "left", color: INK },
      },
      {
        type: "text",
        x: 240,
        ...
        h: 160,
        props: {
          text: "Copy sits on the plate so it stays legible over any backdrop.",
          size: 32,
          weight: 400,
          align: "left",
          color: INK,
  ...
  },
  {
    ...
    parts: [
      { type: "surface", x: 0, y: 0, w: 620, h: 1080, props: { fill: INK, radius: 0, opacity: 1 } },
      {
        ...
        w: 440,
        h: 240,
        props: { text: "Section title", size: 72, weight: 700, align: "left", color: "#FFFFFF" },
      },
      {
        type: "text",
        x: 760,
        ...
        h: 240,
        props: {
          text: "Body copy in the open column beside the band.",
          size: 34,
          weight: 400,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        w: 500,
        h: 380,
        props: { fill: LIGHT, radius: 32, opacity: 1 },
      },
      { type: "text", x: 210, y: 410, w: 400, h: 70, props: kicker({ text: "Card one" }) },
      {
        ...
        h: 200,
        props: {
          text: "Short supporting copy for the first card.",
          size: 28,
          weight: 400,
          align: "left",
          color: INK,
      ...
      { type: "text", x: 760, y: 410, w: 400, h: 70, props: kicker({ text: "Card two" }) },
      {
        ...
        h: 200,
        props: {
          text: "Short supporting copy for the second card.",
          size: 28,
          weight: 400,
          align: "left",
          color: INK,
      ...
      { type: "text", x: 1310, y: 410, w: 400, h: 70, props: kicker({ text: "Card three" }) },
      {
        ...
        h: 200,
        props: {
          text: "Short supporting copy for the third card.",
          size: 28,
          weight: 400,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        w: 1400,
        h: 480,
        props: { fill: INK, radius: 40, opacity: 1 },
      },
      {
        type: "text",
        x: 360,
        ...
        h: 240,
        props: {
          text: "“Reversed type on an ink plate reads as emphasis.”",
          size: 64,
          weight: 600,
          align: "left",
          color: "#FFFFFF",
      ...
      },
      {
        ...
        w: 900,
        h: 60,
        props: kicker({ text: "Name · Role", color: "#A1FBF9" }),
      },
    ],
  },
    ...
    parts: [
      {
        ...
        w: 1000,
        h: 120,
        props: { text: "Agenda", size: 72, weight: 700, align: "left", color: INK },
      },
      {
        type: "text",
        x: 160,
      ...
      },
      {
        ...
        w: 1100,
        h: 70,
        props: { text: "02   What changes", size: 38, weight: 600, align: "left", color: INK },
      },
      {
        type: "text",
        x: 160,
        ...
        w: 1100,
        h: 70,
        props: { text: "03   How we get there", size: 38, weight: 600, align: "left", color: INK },
      },
      {
        type: "text",
        x: 160,
  ...
  },
  {
    ...
    parts: [
      { type: "text", x: 160, y: 300, w: 700, h: 60, props: kicker({ text: "Today" }) },
      {
        ...
        h: 300,
        props: {
          text: "Describe the current state in two or three short lines.",
          size: 34,
          weight: 400,
          align: "left",
          color: INK,
      ...
      },
      {
        ...
        w: 120,
        h: 80,
        props: { text: "→", size: 64, weight: 700, align: "center", color: ACCENT },
      },
      { type: "text", x: 1060, y: 300, w: 700, h: 60, props: kicker({ text: "After" }) },
      {
        ...
        h: 300,
        props: {
          text: "Describe the target state with the same rhythm.",
          size: 34,
          weight: 400,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        w: 400,
        h: 200,
        props: { text: "02", size: 160, weight: 700, align: "left", color: ACCENT },
      },
      {
        type: "text",
        x: 600,
        ...
        w: 1160,
        h: 140,
        props: { text: "Section title", size: 88, weight: 700, align: "left", color: INK },
      },
      {
        type: "text",
        x: 600,
        ...
        h: 90,
        props: {
          text: "One line on what this section proves.",
          size: 34,
          weight: 400,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        w: 320,
        h: 200,
        props: { value: "99%", label: "Metric one", surface: "bare", accent: ACCENT },
      },
      {
        type: "stat",
        x: 460,
        ...
        w: 320,
        h: 200,
        props: { value: "84", label: "Metric two", surface: "bare", accent: ACCENT },
      },
      {
        type: "stat",
        x: 800,
        ...
        w: 320,
        h: 200,
        props: { value: "3.4x", label: "Metric three", surface: "bare", accent: ACCENT },
      },
      {
        type: "stat",
        x: 1140,
        ...
        w: 320,
        h: 200,
        props: { value: "48h", label: "Metric four", surface: "bare", accent: ACCENT },
      },
      {
        type: "stat",
        x: 1480,
        ...
        w: 320,
        h: 200,
        props: { value: "120+", label: "Metric five", surface: "bare", accent: ACCENT },
      },
    ],
  },
  {
    ...
    parts: [
      ...
      },
      {
        ...
        w: 880,
        h: 140,
        props: { text: "What the numbers mean", size: 60, weight: 700, align: "left", color: INK },
      },
      {
        type: "text",
        x: 880,
        ...
        h: 320,
        props: {
          text: "Explain the trend behind the metrics, then say what decision it supports.",
          size: 32,
          weight: 400,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        props: {
          value: "92%",
          label: "The single number this slide is about",
          surface: "bare",
          accent: ACCENT,
        },
      },
      {
        ...
        w: 1320,
        h: 70,
        props: kicker({ text: "Source · period · basis", color: ACCENT }),
      },
    ],
  },
  ...
  },
  {
    ...
    parts: [
      ...
      },
      {
        ...
        w: 740,
        h: 260,
        props: { fit: "cover", radius: 24, alt: "Frame four" },
      },
    ],
  },
  {
    ...
    parts: [
      {
        ...
        w: 1200,
        h: 100,
        props: { text: "Who we work with", size: 64, weight: 700, align: "left", color: INK },
      },
      {
        type: "surface",
        x: 160,
        ...
        w: 500,
        h: 180,
        props: { fill: LIGHT, radius: 24, opacity: 1 },
      },
      {
        type: "image",
        x: 220,
        ...
        w: 380,
        h: 100,
        props: { fit: "contain", radius: 0, alt: "Client logo" },
      },
      {
        type: "surface",
        x: 710,
  ...
  // ----------------------------------------------- more surface layouts
  {
    ...
    parts: [
      ...
      },
      {
        ...
        w: 960,
        h: 740,
        props: { fill: LIGHT, radius: 0, opacity: 1 },
      },
      {
        type: "text",
        x: 1060,
        ...
        h: 300,
        props: {
          text: "Light panel copy for the contrasting point.",
          size: 40,
          weight: 500,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        w: 720,
        h: 250,
        props: { fill: PLATE, radius: 28, opacity: 1 },
      },
      { type: "text", x: 250, y: 330, w: 620, h: 60, props: kicker({ text: "Tile one" }) },
      {
        ...
        w: 620,
        h: 120,
        props: { text: "Short supporting copy.", size: 28, weight: 400, align: "left", color: INK },
      },
      {
        type: "surface",
        x: 1000,
  ...
  },
  {
    ...
    parts: [
      ...
      },
      {
        ...
        h: 300,
        props: {
          text: "Body copy sits in the open space below the band.",
          size: 36,
          weight: 400,
          align: "left",
          color: INK,
    ...
    parts: [
      {
        ...
        w: 220,
        h: 14,
        props: { fill: ACCENT, radius: 8, opacity: 1 },
      },
      {
        type: "text",
        x: 160,
        ...
        h: 180,
        props: {
          text: "Headline anchored by a rule",
          size: 84,
          weight: 700,
          align: "left",
          color: INK,
      ...
      },
      {
        ...
        h: 180,
        props: {
          text: "Supporting copy under the rule.",
          size: 34,
          weight: 400,
          align: "left",
          color: INK,
...
export function expandPreset(
  ...
  return preset.parts.map((part) =>
    make(part.type, { x: part.x + dx, y: part.y + dy, w: part.w, h: part.h }, part.props ?? {}),
  );
}
...
export function expandParts(
  ...
  return expandPreset({ id: "adhoc", category: "data", label: "", hint: "", parts }, at, make);
}
