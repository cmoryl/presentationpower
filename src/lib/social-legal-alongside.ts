...
export const LEGAL_ALONGSIDE_SCENE_TYPE: Record<string, AlongsideSceneType> = {
  "climber-belayer": {
    ...
    callouts: [{ text: "wall", treat: "italic" }],
  },
  "rally-codriver": {
    voice: "technical",
    axis: "rising",
  ...
  "golfer-caddie": {
    ...
    callouts: [{ text: "difficult", treat: "italic" }],
  },
  "tennis-doubles": {
    voice: "compressed",
    axis: "flat",
  ...
  "whitewater-pair": {
    ...
    callouts: [{ text: "Committed", treat: "bold" }],
  },
  "pit-crew": {
    voice: "monoset",
    axis: "flat",
    ...
    callouts: [{ text: "Standing still", treat: "italic" }],
  },
  "mountaineering-pair": {
    voice: "gallery",
    axis: "rising",
  ...
  "lifter-spotter": {
    ...
    callouts: [{ text: "ready", treat: "bold" }],
  },
  "rowing-crew": {
    voice: "caslon",
    axis: "flat",
    ...
    callouts: [{ text: "Under load", treat: "caps" }],
  },
  "surf-safety-rider": {
    voice: "couture",
    axis: "rising",
    ...
    callouts: [{ text: "big one", treat: "italic" }],
  },
};
