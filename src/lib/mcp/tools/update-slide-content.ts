...
export default defineTool({
  ...
  description:
    "Deep-merge a partial content patch into one slide of a deck. Only include the fields you are changing. Numeric values (stats, dates, currency) are protected unless allow_numeric_edits is true.",
  inputSchema: {
