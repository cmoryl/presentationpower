...
import { Route as DevHdrCheckRouteImport } from './routes/dev.hdr-check'
...
const DevHdrCheckRoute = DevHdrCheckRouteImport.update({
  id: '/dev/hdr-check',
  path: '/dev/hdr-check',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/dev/hdr-check': typeof DevHdrCheckRoute
...
export interface RootRouteChildren {
  ...
  DevHdrCheckRoute: typeof DevHdrCheckRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/dev/hdr-check': {
      id: '/dev/hdr-check'
      path: '/dev/hdr-check'
      fullPath: '/dev/hdr-check'
      preLoaderRoute: typeof DevHdrCheckRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/dev/format-verify': {
      id: '/dev/format-verify'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  DevHdrCheckRoute: DevHdrCheckRoute,
