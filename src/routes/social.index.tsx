  ...
  return (
    <>
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="max-w-3xl space-y-4">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <Link
                to="/social/banners"
                className="inline-flex items-center gap-2 rounded-full border border-[#003FC7]/30 bg-gradient-to-r from-[#C2A3FF33] to-[#A1FBF933] px-5 py-2 text-sm font-medium text-[#03002C] hover:border-[#003FC7]/60"
              >
      ...
      <div className="mx-auto max-w-7xl space-y-14 px-4 py-10 sm:px-6 lg:px-8">
        ...
        {/* The three Legal campaign boards moved to their owner's own workspace
            page (see src/lib/live-projects.ts) — they are one person's work in
            progress, not a public entry point on the social tool page. */}
        ...
        <section className="rounded-3xl border border-black/10 bg-white/70 p-6 backdrop-blur">
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[#03002C] px-4 py-2 text-xs font-medium text-primary-foreground hover:bg-primary dark:bg-primary dark:text-primary-foreground"
            >
              <Sparkles size={12} />
