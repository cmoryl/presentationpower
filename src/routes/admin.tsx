    ...
    return (
      <AppShell>
        <div className="space-y-4" aria-busy="true" aria-live="polite">
          <div className="flex items-center gap-2.5 rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm font-medium text-black/70 dark:border-white/10 dark:bg-white/[0.04] dark:text-white/70">
            <Loader2 size={16} className="animate-spin text-black/40 dark:text-white/40" />
            Opening your admin console… checking your access.
          </div>
