...
function PresetsView() {
  ...
  return (
    <>
      <header className="full-bleed relative hero-flush overflow-hidden border-b border-black/5 bg-gradient-to-br from-[#003FC70a] via-white/60 to-[#A1FBF922] py-9 lg:py-12">
