  ...
  return (
    ...
    >
      ...
      <div className="border-t border-black/10 p-4 dark:border-white/10">
        ...
        <span className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#003FC7] px-4 py-2 text-sm font-medium text-white group-hover:opacity-90">
