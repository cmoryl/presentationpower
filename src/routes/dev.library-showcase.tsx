...
/**
 * The library's own token values, mirrored from
 * `src/design-system/element/styles/theme.css`, applied inline on the showcase
 * wrapper. The preview app's global scaffold stylesheet also defines these
 * variables, so scoping them here guarantees the specimens below render the
 * library's tokens — exactly what a consumer receives — and lets the theme
 * toggle flip them without touching the document root.
 */
const ELEMENT_LIGHT: React.CSSProperties = {
  "--radius": "0.625rem",
...
const ELEMENT_DARK: React.CSSProperties = {
  "--radius": "0.625rem",
