...
/**
 * The library owns its token values (`ELEMENT_LIGHT` / `ELEMENT_DARK`, mirrored
 * from `styles/theme.css`); the showcase only scopes them to this wrapper so
 * the specimens render the library's tokens rather than the preview app's
