          ...
          <div className="space-y-6 px-5 py-5">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <button
                onClick={run}
                disabled={!canRun}
                className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2 text-sm font-medium text-primary-foreground transition hover:bg-primary/90 disabled:opacity-50"
              >
                {status.kind === "running" ? (
