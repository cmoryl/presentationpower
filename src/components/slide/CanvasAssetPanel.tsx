...
export function CanvasAssetPanel({
  ...
  return (
    <div
      {...{ [CANVAS_UI_ATTR]: "" }}
      className="flex h-full min-h-0 w-full min-w-0 flex-col overflow-hidden rounded-2xl border border-white/15 bg-[#03002C]/95 text-white shadow-2xl backdrop-blur"
    >
