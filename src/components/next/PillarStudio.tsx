...
import {
  ...
  martLayoutSummary,
  martLayoutsFor,
  type MartLayoutPreset,
} from "@/lib/next-mart-layouts";
...
export function PillarStudio({
  ...
  const martLayouts = martLayoutsFor(config);
  const [appliedMartLayout, setAppliedMartLayout] = useState<string | null>(null);
