    ...
    <div className="flex h-full min-h-0 flex-col">
      <header className="flex flex-wrap items-center gap-3 border-b border-border/60 px-4 py-3">
        ...
        <Link
          to="/decks/$deckId"
          params={{ deckId }}
          className="inline-flex min-h-9 shrink-0 items-center rounded-lg bg-primary px-3 text-xs font-semibold text-primary-foreground transition hover:brightness-110"
        >
          Open in deck editor
        </Link>
      </header>
        ...
        <div className="flex items-center justify-between text-white">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="ml-1 rounded-lg bg-primary px-3 py-1.5 text-xs font-semibold text-primary-foreground transition hover:bg-[#03002C]"
            >
              Close
            </button>
          </div>
