...
- If step 1 reproduction reveals the deck itself carries a stale look (e.g. an old style pack saved in deck context), the fix will honor the _effective_ look the preview shows rather than mutating your deck data.
